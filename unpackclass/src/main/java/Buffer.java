...
public final class Buffer extends Node {
	...
	public void writeLong(@OriginalArg(0) long value) {
	...
	public void writeBytes(@OriginalArg(0) byte[] bytes, @OriginalArg(2) int len) {
	...
	public void readBytes(@OriginalArg(0) byte[] bytes, @OriginalArg(2) int len) {
		for (@Pc(3) int i = 0; i < len; i++) {
	...
	public void xteaDecrypt(@OriginalArg(0) int[] key, @OriginalArg(2) int len) {
