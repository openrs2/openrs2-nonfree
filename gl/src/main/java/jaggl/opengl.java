...
public final class opengl implements GL {
	...
	@Override
	public final void glShaderSourceARB(@OriginalArg(0) int shaderObj, @OriginalArg(1) int count, @OriginalArg(2) String[] string, @OriginalArg(3) int[] length, @OriginalArg(4) int lengthOffset) {
	...
	public final native void glBindProgramARB(@OriginalArg(0) int target, @OriginalArg(1) int program);
	...
	@Override
	public final void glGenProgramsARB(@OriginalArg(0) int n, @OriginalArg(1) int[] programs, @OriginalArg(2) int programsOffset) {
	...
	public final native void glActiveTexture(@OriginalArg(0) int texture);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glMultiTexCoord2i", descriptor = "(III)V")
	public final native void glMultiTexCoord2i(@OriginalArg(0) int target, @OriginalArg(1) int s, @OriginalArg(2) int t);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glAttachObjectARB", descriptor = "(II)V")
	public final native void glAttachObjectARB(@OriginalArg(0) int containerObj, @OriginalArg(1) int obj);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glCheckFramebufferStatusEXT", descriptor = "(I)I")
	public final native int glCheckFramebufferStatusEXT(@OriginalArg(0) int target);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glClientActiveTexture", descriptor = "(I)V")
	public final native void glClientActiveTexture(@OriginalArg(0) int texture);
	...
	@Override
	public final void glGenFramebuffersEXT(@OriginalArg(0) int n, @OriginalArg(1) int[] framebuffers, @OriginalArg(2) int framebuffersOffset) {
	...
	@Override
	public final void glDeleteFramebuffersEXT(@OriginalArg(0) int n, @OriginalArg(1) int[] framebuffers, @OriginalArg(2) int framebuffersOffset) {
	...
	public final native void glBindBufferARB(@OriginalArg(0) int target, @OriginalArg(1) int buffer);
	...
	@Override
	public final void glBufferDataARB(@OriginalArg(0) int target, @OriginalArg(1) int size, @OriginalArg(2) Buffer data, @OriginalArg(3) int usage) {
		if (isDirect(data)) {
	...
	@Override
	public final void glBufferSubDataARB(@OriginalArg(0) int target, @OriginalArg(1) int offset, @OriginalArg(2) int size, @OriginalArg(3) Buffer data) {
		if (isDirect(data)) {
	...
	public final native void glBindFramebufferEXT(@OriginalArg(0) int target, @OriginalArg(1) int framebuffer);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glCompileShaderARB", descriptor = "(I)V")
	public final native void glCompileShaderARB(@OriginalArg(0) int shaderObj);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glCreateProgramObjectARB", descriptor = "()I")
	public final native int glCreateProgramObjectARB();

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glCreateShaderObjectARB", descriptor = "(I)I")
	public final native int glCreateShaderObjectARB(@OriginalArg(0) int shaderType);
	...
	@Override
	public final void glDeleteBuffersARB(@OriginalArg(0) int n, @OriginalArg(1) int[] buffers, @OriginalArg(2) int buffersOffset) {
	...
	public final native void glDeleteObjectARB(@OriginalArg(0) int obj);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glDetachObjectARB", descriptor = "(II)V")
	public final native void glDetachObjectARB(@OriginalArg(0) int containerObj, @OriginalArg(1) int attachedObj);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glFramebufferTexture2DEXT", descriptor = "(IIIII)V")
	public final native void glFramebufferTexture2DEXT(@OriginalArg(0) int target, @OriginalArg(1) int attachment, @OriginalArg(2) int textarget, @OriginalArg(3) int texture, @OriginalArg(4) int level);
	...
	@Override
	public final void glGenBuffersARB(@OriginalArg(0) int n, @OriginalArg(1) int[] buffers, @OriginalArg(2) int buffersOffset) {
	...
	@Override
	public final void glGetObjectParameterivARB(@OriginalArg(0) int obj, @OriginalArg(1) int pname, @OriginalArg(2) int[] params, @OriginalArg(3) int paramsOffset) {
	...
	public final native int glGetUniformLocation(@OriginalArg(0) int program, @OriginalArg(1) String name);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glLinkProgramARB", descriptor = "(I)V")
	public final native void glLinkProgramARB(@OriginalArg(0) int programObj);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glMultiTexCoord2f", descriptor = "(IFF)V")
	public final native void glMultiTexCoord2f(@OriginalArg(0) int target, @OriginalArg(1) float s, @OriginalArg(2) float t);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glProgramLocalParameter4fARB", descriptor = "(IIFFFF)V")
	public final native void glProgramLocalParameter4fARB(@OriginalArg(0) int target, @OriginalArg(1) int index, @OriginalArg(2) float x, @OriginalArg(3) float y, @OriginalArg(4) float z, @OriginalArg(5) float w);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glProgramStringARB", descriptor = "(IIILjava/lang/String;)V")
	public final native void glProgramStringARB(@OriginalArg(0) int target, @OriginalArg(1) int format, @OriginalArg(2) int len, @OriginalArg(3) String string);
	...
	@Override
	public final void glProgramLocalParameter4fvARB(@OriginalArg(0) int target, @OriginalArg(1) int index, @OriginalArg(2) float[] params, @OriginalArg(3) int paramsOffset) {
	...
	@Override
	public final void glProgramLocalParameter4fvARB(@OriginalArg(0) int target, @OriginalArg(1) int index, @OriginalArg(2) FloatBuffer params) {
		if (isDirect(params)) {
	...
	public final native void glPointParameterfARB(@OriginalArg(0) int pname, @OriginalArg(1) float param);
	...
	@Override
	public final void glTexImage3D(@OriginalArg(0) int target, @OriginalArg(1) int level, @OriginalArg(2) int internalformat, @OriginalArg(3) int width, @OriginalArg(4) int height, @OriginalArg(5) int depth, @OriginalArg(6) int border, @OriginalArg(7) int format, @OriginalArg(8) int type, @OriginalArg(9) Buffer pixels) {
		if (isDirect(pixels)) {
	...
	public final native void glUniform1iARB(@OriginalArg(0) int location, @OriginalArg(1) int v0);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glUniform3fARB", descriptor = "(IFFF)V")
	public final native void glUniform3fARB(@OriginalArg(0) int location, @OriginalArg(1) float v0, @OriginalArg(2) float v1, @OriginalArg(3) float v2);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glUseProgramObjectARB", descriptor = "(I)V")
	public final native void glUseProgramObjectARB(@OriginalArg(0) int programObj);
	...
	@Override
	public final void glGetInfoLogARB(@OriginalArg(0) int obj, @OriginalArg(1) int maxLength, @OriginalArg(2) int[] length, @OriginalArg(3) int lengthOffset, @OriginalArg(4) byte[] infoLog, @OriginalArg(5) int infoLogOffset) {
	...
	@Override
	public final void glPointParameterfvARB(@OriginalArg(0) int pname, @OriginalArg(1) float[] params, @OriginalArg(2) int paramsOffset) {
	...
	public final native String glGetString(@OriginalArg(0) int name);
	...
	@Override
	public final void glLightfv(@OriginalArg(0) int light, @OriginalArg(1) int pname, @OriginalArg(2) float[] params, @OriginalArg(3) int paramsOffset) {
		this.glLightfv1(light, pname, params, paramsOffset * 4);
	}

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glBegin", descriptor = "(I)V")
	public final native void glBegin(@OriginalArg(0) int mode);
	...
	public final native void glClear(@OriginalArg(0) int mask);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glEnable", descriptor = "(I)V")
	public final native void glEnable(@OriginalArg(0) int cap);
	...
	public final native void glMatrixMode(@OriginalArg(0) int mode);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glTranslatef", descriptor = "(FFF)V")
	public final native void glTranslatef(@OriginalArg(0) float x, @OriginalArg(1) float y, @OriginalArg(2) float z);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glRotatef", descriptor = "(FFFF)V")
	public final native void glRotatef(@OriginalArg(0) float angle, @OriginalArg(1) float x, @OriginalArg(2) float y, @OriginalArg(3) float z);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glTexCoord2f", descriptor = "(FF)V")
	public final native void glTexCoord2f(@OriginalArg(0) float s, @OriginalArg(1) float t);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glAlphaFunc", descriptor = "(IF)V")
	public final native void glAlphaFunc(@OriginalArg(0) int func, @OriginalArg(1) float ref);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glBlendFunc", descriptor = "(II)V")
	public final native void glBlendFunc(@OriginalArg(0) int sfactor, @OriginalArg(1) int dfactor);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glCallList", descriptor = "(I)V")
	public final native void glCallList(@OriginalArg(0) int list);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glClearDepth", descriptor = "(F)V")
	public final native void glClearDepth(@OriginalArg(0) float depth);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glClearColor", descriptor = "(FFFF)V")
	public final native void glClearColor(@OriginalArg(0) float red, @OriginalArg(1) float green, @OriginalArg(2) float blue, @OriginalArg(3) float alpha);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glBindTexture", descriptor = "(II)V")
	public final native void glBindTexture(@OriginalArg(0) int target, @OriginalArg(1) int texture);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glColor3ub", descriptor = "(BBB)V")
	public final native void glColor3ub(@OriginalArg(0) byte red, @OriginalArg(1) byte green, @OriginalArg(2) byte blue);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glColor4f", descriptor = "(FFFF)V")
	public final native void glColor4f(@OriginalArg(0) float red, @OriginalArg(1) float green, @OriginalArg(2) float blue, @OriginalArg(3) float alpha);
	...
	@Override
	public final void glColor4fv(@OriginalArg(0) float[] v, @OriginalArg(1) int vOffset) {
		this.glColor4fv1(v, vOffset * 4);
	}

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glColor4ub", descriptor = "(BBBB)V")
	public final native void glColor4ub(@OriginalArg(0) byte red, @OriginalArg(1) byte green, @OriginalArg(2) byte blue, @OriginalArg(3) byte alpha);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glColorMaterial", descriptor = "(II)V")
	public final native void glColorMaterial(@OriginalArg(0) int face, @OriginalArg(1) int mode);
	...
	@Override
	public final void glColorPointer(@OriginalArg(0) int size, @OriginalArg(1) int type, @OriginalArg(2) int stride, @OriginalArg(3) Buffer pointer) {
		if (isDirect(pointer)) {
	...
	public final native void glColorPointer(@OriginalArg(0) int size, @OriginalArg(1) int type, @OriginalArg(2) int stride, @OriginalArg(3) long pointer);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glCopyPixels", descriptor = "(IIIII)V")
	public final native void glCopyPixels(@OriginalArg(0) int x, @OriginalArg(1) int y, @OriginalArg(2) int width, @OriginalArg(3) int height, @OriginalArg(4) int type);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glCopyTexImage2D", descriptor = "(IIIIIIII)V")
	public final native void glCopyTexImage2D(@OriginalArg(0) int target, @OriginalArg(1) int level, @OriginalArg(2) int internalformat, @OriginalArg(3) int x, @OriginalArg(4) int y, @OriginalArg(5) int width, @OriginalArg(6) int height, @OriginalArg(7) int border);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glCullFace", descriptor = "(I)V")
	public final native void glCullFace(@OriginalArg(0) int mode);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glDeleteLists", descriptor = "(II)V")
	public final native void glDeleteLists(@OriginalArg(0) int list, @OriginalArg(1) int range);
	...
	@Override
	public final void glDeleteTextures(@OriginalArg(0) int n, @OriginalArg(1) int[] textures, @OriginalArg(2) int texturesOffset) {
		this.glDeleteTextures1(n, textures, texturesOffset * 4);
	}

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glDepthFunc", descriptor = "(I)V")
	public final native void glDepthFunc(@OriginalArg(0) int func);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glDepthMask", descriptor = "(Z)V")
	public final native void glDepthMask(@OriginalArg(0) boolean flag);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glDisable", descriptor = "(I)V")
	public final native void glDisable(@OriginalArg(0) int cap);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glDisableClientState", descriptor = "(I)V")
	public final native void glDisableClientState(@OriginalArg(0) int array);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glDrawBuffer", descriptor = "(I)V")
	public final native void glDrawBuffer(@OriginalArg(0) int buf);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glDrawElements", descriptor = "(IIIJ)V")
	public final native void glDrawElements(@OriginalArg(0) int mode, @OriginalArg(1) int count, @OriginalArg(2) int type, @OriginalArg(3) long indices);
	...
	@Override
	public final void glDrawElements(@OriginalArg(0) int mode, @OriginalArg(1) int count, @OriginalArg(2) int type, @OriginalArg(3) Buffer indices) {
		if (isDirect(indices)) {
	...
	@Override
	public final void glDrawPixels(@OriginalArg(0) int width, @OriginalArg(1) int height, @OriginalArg(2) int format, @OriginalArg(3) int type, @OriginalArg(4) Buffer pixels) {
		if (isDirect(pixels)) {
	...
	public final native void glEnableClientState(@OriginalArg(0) int array);
	...
	public final native void glFogf(@OriginalArg(0) int pname, @OriginalArg(1) float param);
	...
	@Override
	public final void glFogfv(@OriginalArg(0) int pname, @OriginalArg(1) float[] params, @OriginalArg(2) int paramsOffset) {
		this.glFogfv1(pname, params, paramsOffset * 4);
	}

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glFogi", descriptor = "(II)V")
	public final native void glFogi(@OriginalArg(0) int pname, @OriginalArg(1) int param);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glGenLists", descriptor = "(I)I")
	public final native int glGenLists(@OriginalArg(0) int range);
	...
	@Override
	public final void glGenTextures(@OriginalArg(0) int n, @OriginalArg(1) int[] textures, @OriginalArg(2) int texturesOffset) {
	...
	@Override
	public final void glGetFloatv(@OriginalArg(0) int pname, @OriginalArg(1) FloatBuffer data) {
		if (isDirect(data)) {
	...
	@Override
	public final void glGetFloatv(@OriginalArg(0) int pname, @OriginalArg(1) float[] data, @OriginalArg(2) int dataOffset) {
	...
	@Override
	public final void glGetIntegerv(@OriginalArg(0) int pname, @OriginalArg(1) int[] data, @OriginalArg(2) int dataOffset) {
		this.glGetIntegerv1(pname, data, dataOffset * 4);
	}

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glHint", descriptor = "(II)V")
	public final native void glHint(@OriginalArg(0) int target, @OriginalArg(1) int mode);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glInterleavedArrays", descriptor = "(IIJ)V")
	public final native void glInterleavedArrays(@OriginalArg(0) int format, @OriginalArg(1) int stride, @OriginalArg(2) long pointer);
	...
	@Override
	public final void glInterleavedArrays(@OriginalArg(0) int format, @OriginalArg(1) int stride, @OriginalArg(2) Buffer pointer) {
		if (isDirect(pointer)) {
	...
	@Override
	public final void glLightModelfv(@OriginalArg(0) int pname, @OriginalArg(1) float[] params, @OriginalArg(2) int paramsOffset) {
		this.glLightModelfv1(pname, params, paramsOffset * 4);
	}

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glLightf", descriptor = "(IIF)V")
	public final native void glLightf(@OriginalArg(0) int light, @OriginalArg(1) int pname, @OriginalArg(2) float param);
	...
	@Override
	public final void glLoadMatrixf(@OriginalArg(0) float[] m, @OriginalArg(1) int mOffset) {
	...
	@Override
	public final void glMaterialfv(@OriginalArg(0) int face, @OriginalArg(1) int pname, @OriginalArg(2) float[] params, @OriginalArg(3) int paramsOffset) {
		this.glMaterialfv1(face, pname, params, paramsOffset * 4);
	}

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glNewList", descriptor = "(II)V")
	public final native void glNewList(@OriginalArg(0) int list, @OriginalArg(1) int mode);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glNormal3f", descriptor = "(FFF)V")
	public final native void glNormal3f(@OriginalArg(0) float nx, @OriginalArg(1) float ny, @OriginalArg(2) float nz);
	...
	@Override
	public final void glNormalPointer(@OriginalArg(0) int type, @OriginalArg(1) int stride, @OriginalArg(2) Buffer pointer) {
		if (isDirect(pointer)) {
	...
	public final native void glNormalPointer(@OriginalArg(0) int type, @OriginalArg(1) int stride, @OriginalArg(2) long pointer);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glOrtho", descriptor = "(DDDDDD)V")
	public final native void glOrtho(@OriginalArg(0) double left, @OriginalArg(1) double right, @OriginalArg(2) double bottom, @OriginalArg(3) double top, @OriginalArg(4) double zNear, @OriginalArg(5) double zFar);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glPointSize", descriptor = "(F)V")
	public final native void glPointSize(@OriginalArg(0) float size);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glPolygonMode", descriptor = "(II)V")
	public final native void glPolygonMode(@OriginalArg(0) int face, @OriginalArg(1) int mode);
	...
	public final native void glPushAttrib(@OriginalArg(0) int mask);
	...
	public final native void glRasterPos2i(@OriginalArg(0) int x, @OriginalArg(1) int y);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glReadBuffer", descriptor = "(I)V")
	public final native void glReadBuffer(@OriginalArg(0) int src);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glScalef", descriptor = "(FFF)V")
	public final native void glScalef(@OriginalArg(0) float x, @OriginalArg(1) float y, @OriginalArg(2) float z);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glScissor", descriptor = "(IIII)V")
	public final native void glScissor(@OriginalArg(0) int x, @OriginalArg(1) int y, @OriginalArg(2) int width, @OriginalArg(3) int height);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glShadeModel", descriptor = "(I)V")
	public final native void glShadeModel(@OriginalArg(0) int mode);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glTexCoord2i", descriptor = "(II)V")
	public final native void glTexCoord2i(@OriginalArg(0) int s, @OriginalArg(1) int t);
	...
	public final native void glTexCoordPointer(@OriginalArg(0) int size, @OriginalArg(1) int type, @OriginalArg(2) int stride, @OriginalArg(3) long pointer);
	...
	@Override
	public final void glTexCoordPointer(@OriginalArg(0) int size, @OriginalArg(1) int type, @OriginalArg(2) int stride, @OriginalArg(3) Buffer pointer) {
		if (isDirect(pointer)) {
	...
	public final native void glTexEnvf(@OriginalArg(0) int target, @OriginalArg(1) int pname, @OriginalArg(2) float param);
	...
	@Override
	public final void glTexEnvfv(@OriginalArg(0) int target, @OriginalArg(1) int pname, @OriginalArg(2) float[] params, @OriginalArg(3) int paramsOffset) {
		this.glTexEnvfv1(target, pname, params, paramsOffset * 4);
	}

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glTexEnvi", descriptor = "(III)V")
	public final native void glTexEnvi(@OriginalArg(0) int target, @OriginalArg(1) int pname, @OriginalArg(2) int param);
	...
	@Override
	public final void glTexGenfv(@OriginalArg(0) int coord, @OriginalArg(1) int pname, @OriginalArg(2) float[] params, @OriginalArg(3) int paramsOffset) {
		this.glTexGenfv1(coord, pname, params, paramsOffset * 4);
	}

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glTexGeni", descriptor = "(III)V")
	public final native void glTexGeni(@OriginalArg(0) int coord, @OriginalArg(1) int pname, @OriginalArg(2) int param);
	...
	@Override
	public final void glTexImage1D(@OriginalArg(0) int target, @OriginalArg(1) int level, @OriginalArg(2) int internalformat, @OriginalArg(3) int width, @OriginalArg(4) int border, @OriginalArg(5) int format, @OriginalArg(6) int type, @OriginalArg(7) Buffer pixels) {
		if (isDirect(pixels)) {
	...
	@Override
	public final void glTexImage2D(@OriginalArg(0) int target, @OriginalArg(1) int level, @OriginalArg(2) int internalformat, @OriginalArg(3) int width, @OriginalArg(4) int height, @OriginalArg(5) int border, @OriginalArg(6) int format, @OriginalArg(7) int type, @OriginalArg(8) Buffer pixels) {
		if (isDirect(pixels)) {
	...
	public final native void glTexParameteri(@OriginalArg(0) int target, @OriginalArg(1) int pname, @OriginalArg(2) int param);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glVertex2f", descriptor = "(FF)V")
	public final native void glVertex2f(@OriginalArg(0) float x, @OriginalArg(1) float y);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glVertex2i", descriptor = "(II)V")
	public final native void glVertex2i(@OriginalArg(0) int x, @OriginalArg(1) int y);
	...
	@Override
	public final void glVertexPointer(@OriginalArg(0) int size, @OriginalArg(1) int type, @OriginalArg(2) int stride, @OriginalArg(3) Buffer pointer) {
		if (isDirect(pointer)) {
	...
	public final native void glVertexPointer(@OriginalArg(0) int size, @OriginalArg(1) int type, @OriginalArg(2) int stride, @OriginalArg(3) long pointer);
	...
	public final native void glViewport(@OriginalArg(0) int x, @OriginalArg(1) int y, @OriginalArg(2) int width, @OriginalArg(3) int height);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glColorMask", descriptor = "(ZZZZ)V")
	public final native void glColorMask(@OriginalArg(0) boolean red, @OriginalArg(1) boolean green, @OriginalArg(2) boolean blue, @OriginalArg(3) boolean alpha);
	...
	@Override
	public final void glGenRenderbuffersEXT(@OriginalArg(0) int n, @OriginalArg(1) int[] renderbuffers, @OriginalArg(2) int renderbuffersOffset) {
	...
	@Override
	public final void glDeleteRenderbuffersEXT(@OriginalArg(0) int n, @OriginalArg(1) int[] renderbuffers, @OriginalArg(2) int renderbuffersOffset) {
	...
	public final native void glBindRenderbufferEXT(@OriginalArg(0) int target, @OriginalArg(1) int renderbuffer);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glFramebufferRenderbufferEXT", descriptor = "(IIII)V")
	public final native void glFramebufferRenderbufferEXT(@OriginalArg(0) int target, @OriginalArg(1) int attachment, @OriginalArg(2) int renderbuffertarget, @OriginalArg(3) int renderbuffer);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glRenderbufferStorageEXT", descriptor = "(IIII)V")
	public final native void glRenderbufferStorageEXT(@OriginalArg(0) int target, @OriginalArg(1) int internalformat, @OriginalArg(2) int width, @OriginalArg(3) int height);

	@OriginalMember(owner = "gl!jaggl/opengl", name = "glDrawArrays", descriptor = "(III)V")
	public final native void glDrawArrays(@OriginalArg(0) int mode, @OriginalArg(1) int first, @OriginalArg(2) int count);
