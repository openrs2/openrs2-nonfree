		...
		while (!this.aBoolean174) {
			...
			try {
				if (local15.anInt181 == 2) {
					local15.aClass60_1.write((int) local15.secondaryKey, local15.aByteArray3, local15.aByteArray3.length);
				} else if (local15.anInt181 == 3) {
					local15.aByteArray3 = local15.aClass60_1.read((int) local15.secondaryKey);
				}
	...
	public final Class4_Sub3_Sub1_Sub1 method1973(@OriginalArg(1) Cache arg0, @OriginalArg(2) int arg1) {
		...
		synchronized (this.aClass175_10) {
			...
			while (true) {
				...
				if (local23.secondaryKey == (long) arg1 && arg0 == local23.aClass60_1 && local23.anInt181 == 2) {
