...
public final class SoftwareModel extends Model {
	...
	private static final SoftwareModel aClass53_Sub4_Sub1_1 = new SoftwareModel();

	@OriginalMember(owner = "client!na", name = "fb", descriptor = "Lclient!na;")
	private static final SoftwareModel aClass53_Sub4_Sub1_2 = new SoftwareModel();

	@OriginalMember(owner = "client!na", name = "gb", descriptor = "Lclient!na;")
	private static final SoftwareModel aClass53_Sub4_Sub1_3 = new SoftwareModel();

	@OriginalMember(owner = "client!na", name = "mb", descriptor = "[I")
	private static final int[] anIntArray357 = new int[8192];

	@OriginalMember(owner = "client!na", name = "nb", descriptor = "[I")
	private static final int[] anIntArray358 = new int[12];

	@OriginalMember(owner = "client!na", name = "rb", descriptor = "[I")
	private static final int[] anIntArray361 = new int[4096];

	@OriginalMember(owner = "client!na", name = "sb", descriptor = "[I")
	private static final int[] anIntArray362 = new int[8192];

	@OriginalMember(owner = "client!na", name = "yb", descriptor = "[I")
	private static final int[] anIntArray365 = new int[8192];

	@OriginalMember(owner = "client!na", name = "zb", descriptor = "[I")
	private static final int[] anIntArray366 = new int[12];

	@OriginalMember(owner = "client!na", name = "Ab", descriptor = "[I")
	private static final int[] anIntArray367 = new int[4096];

	@OriginalMember(owner = "client!na", name = "Bb", descriptor = "[I")
	private static final int[] anIntArray368 = new int[8192];

	@OriginalMember(owner = "client!na", name = "Db", descriptor = "[Z")
	private static final boolean[] aBooleanArray16 = new boolean[4096];

	@OriginalMember(owner = "client!na", name = "Hb", descriptor = "[I")
	private static final int[] anIntArray370 = new int[4096];

	@OriginalMember(owner = "client!na", name = "Ib", descriptor = "[I")
	private static final int[] anIntArray371 = new int[4096];

	@OriginalMember(owner = "client!na", name = "Jb", descriptor = "[I")
	private static final int[] anIntArray372 = new int[4096];

	@OriginalMember(owner = "client!na", name = "Lb", descriptor = "[Z")
	private static final boolean[] aBooleanArray17 = new boolean[4096];

	@OriginalMember(owner = "client!na", name = "Ob", descriptor = "[I")
	private static final int[] anIntArray375 = new int[8192];

	@OriginalMember(owner = "client!na", name = "Qb", descriptor = "[I")
	private static final int[] anIntArray376 = new int[4096];

	@OriginalMember(owner = "client!na", name = "Rb", descriptor = "[I")
	private static final int[] anIntArray377 = new int[10];

	@OriginalMember(owner = "client!na", name = "Sb", descriptor = "[[I")
	private static final int[][] anIntArrayArray33 = new int[12][4096];

	@OriginalMember(owner = "client!na", name = "Tb", descriptor = "[I")
	private static final int[] anIntArray378 = new int[4096];

	@OriginalMember(owner = "client!na", name = "Ub", descriptor = "[I")
	private static final int[] anIntArray379 = new int[4096];

	@OriginalMember(owner = "client!na", name = "Wb", descriptor = "[I")
	private static final int[] anIntArray380 = new int[10];

	@OriginalMember(owner = "client!na", name = "Xb", descriptor = "[I")
	private static final int[] anIntArray381 = new int[10];

	@OriginalMember(owner = "client!na", name = "O", descriptor = "[B")
	private static byte[] aByteArray44 = new byte[1];

	@OriginalMember(owner = "client!na", name = "V", descriptor = "[I")
	private static int[] anIntArray349 = new int[1];

	@OriginalMember(owner = "client!na", name = "W", descriptor = "[I")
	private static int[] anIntArray350 = new int[1];

	@OriginalMember(owner = "client!na", name = "cb", descriptor = "[I")
	private static int[] anIntArray352 = new int[1];

	@OriginalMember(owner = "client!na", name = "eb", descriptor = "[S")
	private static short[] aShortArray65 = new short[1];

	@OriginalMember(owner = "client!na", name = "hb", descriptor = "[I")
	private static int[] anIntArray354 = new int[1];

	@OriginalMember(owner = "client!na", name = "ib", descriptor = "[S")
	private static short[] aShortArray66 = new short[1];

	@OriginalMember(owner = "client!na", name = "jb", descriptor = "[B")
	private static byte[] aByteArray45 = new byte[1];

	@OriginalMember(owner = "client!na", name = "kb", descriptor = "[I")
	private static int[] anIntArray355 = new int[1];

	@OriginalMember(owner = "client!na", name = "lb", descriptor = "[I")
	private static int[] anIntArray356 = new int[1];

	@OriginalMember(owner = "client!na", name = "ob", descriptor = "[I")
	private static int[] anIntArray359 = new int[1];

	@OriginalMember(owner = "client!na", name = "ub", descriptor = "I")
	private static int anInt3441 = 0;

	@OriginalMember(owner = "client!na", name = "xb", descriptor = "[I")
	private static int[] anIntArray364 = new int[1];

	@OriginalMember(owner = "client!na", name = "Eb", descriptor = "[S")
	private static short[] aShortArray67 = new short[1];

	@OriginalMember(owner = "client!na", name = "Fb", descriptor = "[B")
	private static byte[] aByteArray46 = new byte[1];

	@OriginalMember(owner = "client!na", name = "Kb", descriptor = "[I")
	private static int[] anIntArray373 = new int[1];

	@OriginalMember(owner = "client!na", name = "Nb", descriptor = "Z")
	private static boolean aBoolean246 = false;

	@OriginalMember(owner = "client!na", name = "Pb", descriptor = "Z")
	private static boolean aBoolean247 = false;

	@OriginalMember(owner = "client!na", name = "pb", descriptor = "[[I")
	private static int[][] anIntArrayArray31;

	@OriginalMember(owner = "client!na", name = "qb", descriptor = "[I")
	private static int[] anIntArray360;

	@OriginalMember(owner = "client!na", name = "tb", descriptor = "[[I")
	private static int[][] anIntArrayArray32;
	...
	private static int[] anIntArray369;
	...
	private static int method2914(@OriginalArg(0) int arg0) {
		if (arg0 < 2) {
			arg0 = 2;
		} else if (arg0 > 126) {
			arg0 = 126;
	...
	public SoftwareModel(@OriginalArg(0) RawModel model, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		if (model.triangleTextures == null) {
			...
			for (@Pc(148) int i = 0; i < this.triangleCount; i++) {
				@Pc(157) short texture = model.triangleTextures[i];
				if (texture != -1 && Rasteriser.textureProvider.method441(texture)) {
					this.aShortArray61[i] = texture;
				} else {
					this.aShortArray61[i] = -1;
				}
			}
		}
		...
		for (@Pc(372) int local372 = 0; local372 < this.triangleCount; local372++) {
			...
			if (local403 == -1) {
				if (local381 == 0) {
					...
					this.anIntArray345[local372] = local483 | method2912(local431, local483 >> 17);
					...
					this.anIntArray346[local372] = local546 | method2912(local431, local546 >> 17);
					...
					this.anIntArray342[local372] = local609 | method2912(local431, local609 >> 17);
				} else if (local381 == 1) {
					...
					this.anIntArray345[local372] = local654 | method2912(model.triangleColors[local372] & 0xFFFF, local654 >> 17);
				...
				this.anIntArray345[local372] = method2914(local748);
				...
				this.anIntArray346[local372] = method2914(local804);
				...
				this.anIntArray342[local372] = method2914(local860);
			} else if (local381 == 1) {
				...
				this.anIntArray345[local372] = method2914(local898);
				this.anIntArray342[local372] = -1;
			} else {
				this.anIntArray342[local372] = -2;
			}
	...
	private SoftwareModel(@OriginalArg(0) SoftwareModel[] arg0, @OriginalArg(1) int arg1) {
		...
		for (@Pc(48) int local48 = 0; local48 < arg1; local48++) {
			...
			if (local55 != null) {
				...
				if (local55.trianglePriorities == null) {
					if (this.priority == -1) {
						this.priority = local55.priority;
					}
					if (this.priority != local55.priority) {
						local24 = true;
					}
				} else {
					local24 = true;
		...
		for (@Pc(269) int local269 = 0; local269 < arg1; local269++) {
			...
			if (local276 != null) {
				for (@Pc(280) int local280 = 0; local280 < local276.triangleCount; local280++) {
					...
					if (local24) {
						if (local276.trianglePriorities == null) {
							this.trianglePriorities[this.triangleCount] = local276.priority;
						} else {
							this.trianglePriorities[this.triangleCount] = local276.trianglePriorities[local280];
						}
					}
	...
	public Model method3831(@OriginalArg(0) boolean shareAlpha, @OriginalArg(1) boolean shareColors, @OriginalArg(2) boolean shareNormals) {
		...
		if (!shareColors && aShortArray65.length < this.triangleCount) {
			anIntArray350 = new int[this.triangleCount + 100];
			anIntArray349 = new int[this.triangleCount + 100];
			anIntArray352 = new int[this.triangleCount + 100];
			aShortArray65 = new short[this.triangleCount + 100];
		}
		return this.method2908(shareAlpha, shareColors, aClass53_Sub4_Sub1_1, aByteArray44, aShortArray65, anIntArray350, anIntArray349, anIntArray352);
	}
	...
	private void method2902(@OriginalArg(0) boolean arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) long key, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) ParticleSystem particleSystem) {
		if (arg4 >= 1600) {
			return;
		}
		@Pc(5) int local5 = 0;
		@Pc(7) int local7 = 0;
		if (!aBoolean246) {
			for (@Pc(11) int i = 0; i < 1600; i++) {
				anIntArray374[i] = 0;
			}
			for (@Pc(22) int i = 0; i < 32; i++) {
				anIntArray363[i] = 0;
			}
			anInt3441 = 0;
		}
		for (@Pc(35) int i = 0; i < this.triangleCount; i++) {
			if (this.anIntArray342[i] != -2) {
				@Pc(51) int a = this.triangleVertexA[i];
				@Pc(56) int b = this.triangleVertexB[i];
				@Pc(61) int c = this.triangleVertexC[i];
				@Pc(65) int local65 = anIntArray379[a];
				@Pc(69) int local69 = anIntArray379[b];
				@Pc(73) int local73 = anIntArray379[c];
				if (arg0 && (local65 == -5000 || local69 == -5000 || local73 == -5000)) {
					@Pc(88) int local88 = anIntArray370[a];
					@Pc(92) int local92 = anIntArray370[b];
					@Pc(96) int local96 = anIntArray370[c];
					@Pc(100) int local100 = anIntArray367[a];
					@Pc(104) int local104 = anIntArray367[b];
					@Pc(108) int local108 = anIntArray367[c];
					@Pc(112) int local112 = anIntArray372[a];
					@Pc(116) int local116 = anIntArray372[b];
					@Pc(120) int local120 = anIntArray372[c];
					local88 -= local92;
					local96 -= local92;
					local100 -= local104;
					local108 -= local104;
					...
					if (local92 * local152 + local104 * local160 + local116 * local168 > 0) {
						aBooleanArray17[i] = true;
						if (aBoolean246) {
							anIntArray369[local5] = (anIntArray376[a] + anIntArray376[b] + anIntArray376[c]) / 3;
							anIntArray360[local5++] = i;
						} else {
							@Pc(224) int local224 = (anIntArray376[a] + anIntArray376[b] + anIntArray376[c]) / 3 + arg3;
							if (anIntArray374[local224] < 64) {
								anIntArrayArray32[local224][anIntArray374[local224]++] = i;
							} else {
								...
								if (local247 == 64) {
									...
									anIntArray374[local224] = local247 = anInt3441++ + 65;
								}
								@Pc(267) int local267 = local247 - 65;
								anIntArrayArray31[local267][anIntArray363[local267]++] = i;
							}
						}
					}
				} else {
					if (arg1 && this.method2901(Static7.anInt5333 + Rasteriser.anInt3125, Static1.anInt3 + Rasteriser.anInt3126, anIntArray361[a], anIntArray361[b], anIntArray361[c], local65, local69, local73)) {
						Static5.keys[Static7.keysSize++] = key;
						arg1 = false;
					}
					if ((local65 - local69) * (anIntArray361[c] - anIntArray361[b]) - (anIntArray361[a] - anIntArray361[b]) * (local73 - local69) > 0) {
						aBooleanArray17[i] = false;
						if (local65 >= 0 && local69 >= 0 && local73 >= 0 && local65 <= Rasteriser.anInt3129 && local69 <= Rasteriser.anInt3129 && local73 <= Rasteriser.anInt3129) {
							aBooleanArray16[i] = false;
						} else {
							aBooleanArray16[i] = true;
						}
						if (aBoolean246) {
							anIntArray369[local5] = (anIntArray376[a] + anIntArray376[b] + anIntArray376[c]) / 3;
							anIntArray360[local5++] = i;
						} else {
							@Pc(406) int local406 = (anIntArray376[a] + anIntArray376[b] + anIntArray376[c]) / 3 + arg3;
							if (anIntArray374[local406] < 64) {
								anIntArrayArray32[local406][anIntArray374[local406]++] = i;
							} else {
								@Pc(429) int local429 = anIntArray374[local406];
								if (local429 == 64) {
									if (anInt3441 == 512) {
										continue;
									}
									anIntArray374[local406] = local429 = anInt3441++ + 65;
								}
								@Pc(449) int local449 = local429 - 65;
								anIntArrayArray31[local449][anIntArray363[local449]++] = i;
							}
						}
					}
				}
		...
		if (particleSystem != null && !aBoolean246) {
			for (@Pc(470) int i = 0; i < anIntArray368.length; i++) {
				@Pc(480) int local480 = anIntArray368[i] + arg3;
				if (local480 >= 0 && local480 < 1600) {
					if (anIntArray374[local480] < 64) {
						anIntArrayArray32[local480][anIntArray374[local480]++] = i + 1 << 16;
					} else {
						@Pc(512) int local512 = anIntArray374[local480];
						if (local512 == 64) {
							if (anInt3441 == 512) {
								continue;
							}
							anIntArray374[local480] = local512 = anInt3441++ + 65;
						}
						@Pc(532) int local532 = local512 - 65;
						anIntArrayArray31[local532][anIntArray363[local532]++] = i + 1 << 16;
					}
				}
			}
		}
		if (aBoolean246) {
			...
			if (this.trianglePriorities == null) {
				for (@Pc(566) int i = 0; i < local5; i++) {
					this.method2904(anIntArray360[i]);
				}
				return;
			}
			for (@Pc(579) int i = 0; i < 12; i++) {
				anIntArray366[i] = 0;
				anIntArray358[i] = 0;
			}
			for (@Pc(594) int i = 0; i < local5; i++) {
				@Pc(601) int local601 = anIntArray360[i];
				@Pc(605) int local605 = anIntArray369[i];
				@Pc(610) byte priority = this.trianglePriorities[local601];
				@Pc(619) int local619 = anIntArray366[priority]++;
				anIntArrayArray33[priority][local619] = local601;
				if (priority < 10) {
					@Pc(629) int[] local629 = anIntArray358;
					local629[priority] += local605;
				} else if (priority == 10) {
					anIntArray371[local619] = local605;
				} else {
					anIntArray378[local619] = local605;
				}
			}
		} else if (this.trianglePriorities == null) {
			for (@Pc(658) int i = arg4 - 1; i >= 0; i--) {
				@Pc(664) int local664 = anIntArray374[i];
				if (local664 > 0) {
					@Pc(673) int local673 = local664 > 64 ? 64 : local664;
					@Pc(677) int[] local677 = anIntArrayArray32[i];
					for (@Pc(679) int local679 = 0; local679 < local673; local679++) {
						...
						if (local686 < 65536) {
							...
							@Pc(706) Particle particle = particleSystem.particles[local701];
							@Pc(712) int local712 = anIntArray375[local701] * 400;
							if (local712 == 0) {
								local712 = 1;
							}
				...
				if (local664 > 64) {
					@Pc(752) int local752 = anIntArray374[i] - 64 - 1;
					@Pc(756) int[] local756 = anIntArrayArray31[local752];
					for (@Pc(758) int local758 = 0; local758 < anIntArray363[local752]; local758++) {
						@Pc(767) int local767 = local756[local758];
						if (local767 < 65536) {
							this.method2904(local756[local758]);
						} else {
							@Pc(782) int local782 = (local767 >> 16) - 1;
							@Pc(787) Particle particle = particleSystem.particles[local782];
							@Pc(793) int local793 = anIntArray375[local782] * 400;
							if (local793 == 0) {
								local793 = 1;
							}
			...
			for (@Pc(827) int i = 0; i < 12; i++) {
				anIntArray366[i] = 0;
				anIntArray358[i] = 0;
			}
			for (@Pc(844) int i = arg4 - 1; i >= 0; i--) {
				@Pc(850) int local850 = anIntArray374[i];
				if (local850 > 0) {
					@Pc(857) int local857;
					if (local850 > 64) {
						local857 = 64;
					...
					@Pc(864) int[] local864 = anIntArrayArray32[i];
					for (@Pc(866) int local866 = 0; local866 < local857; local866++) {
						@Pc(873) int local873 = local864[local866];
						if (local873 < 65536) {
							@Pc(881) byte priority = this.trianglePriorities[local873];
							@Pc(890) int local890 = anIntArray366[priority]++;
							anIntArrayArray33[priority][local890] = local873;
							if (priority < 10) {
								@Pc(900) int[] local900 = anIntArray358;
								local900[priority] += i;
							} else if (priority == 10) {
								anIntArray371[local890] = i;
							} else {
								anIntArray378[local890] = i;
							}
						} else {
							anIntArray365[local7++] = (local873 >> 16) - 1;
						}
					}
				}
				if (local850 > 64) {
					@Pc(942) int local942 = anIntArray374[i] - 64 - 1;
					@Pc(946) int[] local946 = anIntArrayArray31[local942];
					for (@Pc(948) int local948 = 0; local948 < anIntArray363[local942]; local948++) {
						@Pc(957) int local957 = local946[local948];
						if (local957 < 65536) {
							@Pc(965) byte local965 = this.trianglePriorities[local957];
							@Pc(974) int local974 = anIntArray366[local965]++;
							anIntArrayArray33[local965][local974] = local957;
							if (local965 < 10) {
								@Pc(984) int[] local984 = anIntArray358;
								local984[local965] += i;
							} else if (local965 == 10) {
								anIntArray371[local974] = i;
							} else {
								anIntArray378[local974] = i;
							}
						} else {
							anIntArray365[local7++] = (local957 >> 16) - 1;
						}
					}
				}
			}
		...
		if (anIntArray366[1] > 0 || anIntArray366[2] > 0) {
			local1019 = (anIntArray358[1] + anIntArray358[2]) / (anIntArray366[1] + anIntArray366[2]);
		}
		@Pc(1045) int local1045 = 0;
		if (anIntArray366[3] > 0 || anIntArray366[4] > 0) {
			local1045 = (anIntArray358[3] + anIntArray358[4]) / (anIntArray366[3] + anIntArray366[4]);
		}
		@Pc(1071) int local1071 = 0;
		if (anIntArray366[6] > 0 || anIntArray366[8] > 0) {
			local1071 = (anIntArray358[6] + anIntArray358[8]) / (anIntArray366[6] + anIntArray366[8]);
		}
		@Pc(1097) int local1097 = 0;
		@Pc(1101) int local1101 = anIntArray366[10];
		@Pc(1105) int[] local1105 = anIntArrayArray33[10];
		@Pc(1107) int[] local1107 = anIntArray371;
		@Pc(1109) int local1109 = 0;
		if (local1101 == 0) {
			local1097 = 0;
			local1101 = anIntArray366[11];
			local1105 = anIntArrayArray33[11];
			local1107 = anIntArray378;
		}
		...
		for (@Pc(1136) int i = 0; i < 10; i++) {
			while (i == 0 && local1131 > local1019) {
				this.method2904(local1105[local1097++]);
				if (local1097 == local1101 && local1105 != anIntArrayArray33[11]) {
					local1097 = 0;
					local1101 = anIntArray366[11];
					local1105 = anIntArrayArray33[11];
					local1107 = anIntArray378;
			...
			@Pc(1271) int local1271 = anIntArray366[i];
			@Pc(1275) int[] local1275 = anIntArrayArray33[i];
			if (particleSystem != null) {
				@Pc(1279) int local1279 = Integer.MAX_VALUE;
				if (local1271 != 0) {
					local1279 = anIntArray358[i] / local1271;
				}
				for (@Pc(1291) int local1291 = anIntArray365[local1109]; anIntArray368[local1291] + arg3 > local1279; local1291 = anIntArray365[local1109++]) {
					@Pc(1303) Particle local1303 = particleSystem.particles[local1291];
					@Pc(1309) int local1309 = anIntArray375[local1291] * 400;
					if (local1309 == 0) {
						local1309 = 1;
					}
		...
		@Pc(1405) int local1405 = anIntArray365[local1109];
		while (local1109 < local7) {
			@Pc(1413) Particle particle = particleSystem.particles[local1405];
			@Pc(1419) int local1419 = anIntArray375[local1405] * 400;
			if (local1419 == 0) {
				local1419 = 1;
			}
	...
	public void method3805(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) long key, @OriginalArg(9) int arg9, @OriginalArg(10) ParticleSystem arg10) {
		...
		@Pc(223) int local223 = Rasteriser.anInt3125;
		@Pc(225) int local225 = Rasteriser.anInt3126;
		...
		if (key > 0L && Static1.aBoolean8 && local53 > 0) {
			@Pc(255) int local255;
			@Pc(259) int local259;
			if (local122 > 0) {
		...
		for (@Pc(597) int local597 = 0; local597 < this.vertexCount; local597++) {
			...
			anIntArray376[local597] = local652 - local24;
			if (local652 >= 50) {
				anIntArray379[local597] = local223 + (local644 << 9) / local652;
				anIntArray361[local597] = local225 + (local662 << 9) / local652;
			} else {
				anIntArray379[local597] = -5000;
				local205 = true;
			}
			if (local221) {
				anIntArray370[local597] = local644;
				anIntArray367[local597] = local662;
				anIntArray372[local597] = local652;
			}
		}
		if (arg10 != null) {
			...
			for (@Pc(760) int local760 = 0; local760 < arg10.particles.length; local760++) {
				...
				if (local770 == null || local770.aBoolean228) {
					...
					if (local796 >= 50) {
						anIntArray362[local760] = local754 + (local782 << 9) / local796;
						anIntArray357[local760] = local758 + (local806 << 9) / local796;
						anIntArray375[local760] = local796;
						anIntArray368[local760] = local796 - local24;
					} else {
						anIntArray368[local760] = Integer.MIN_VALUE;
					}
				}
		...
		try {
			this.method2902(local205, local241, key, local24 - local53, local38 + 2 - local53, arg10);
	...
	private void method2904(@OriginalArg(0) int triangle) {
		if (aBooleanArray17[triangle]) {
			this.method2907(triangle);
			return;
		}
		@Pc(12) int a = this.triangleVertexA[triangle];
		@Pc(17) int b = this.triangleVertexB[triangle];
		@Pc(22) int c = this.triangleVertexC[triangle];
		Rasteriser.aBoolean217 = aBooleanArray16[triangle];
		if (this.triangleAlpha == null) {
			Rasteriser.alpha = 0;
		} else {
			Rasteriser.alpha = this.triangleAlpha[triangle] & 0xFF;
		}
		if (this.aShortArray61 != null && this.aShortArray61[triangle] != -1) {
			@Pc(141) int local141;
			@Pc(146) int local146;
			@Pc(151) int local151;
			if (this.aByteArray43 == null || this.aByteArray43[triangle] == -1) {
				local141 = a;
				local146 = b;
				local151 = c;
			} else {
				@Pc(136) int local136 = this.aByteArray43[triangle] & 0xFF;
				local141 = this.anIntArray351[local136];
				local146 = this.anIntArray353[local136];
				local151 = this.anIntArray341[local136];
			}
			if (this.anIntArray342[triangle] == -1) {
				Rasteriser.method2549(anIntArray361[a], anIntArray361[b], anIntArray361[c], anIntArray379[a], anIntArray379[b], anIntArray379[c], this.anIntArray345[triangle], this.anIntArray345[triangle], this.anIntArray345[triangle], anIntArray370[local141], anIntArray370[local146], anIntArray370[local151], anIntArray367[local141], anIntArray367[local146], anIntArray367[local151], anIntArray372[local141], anIntArray372[local146], anIntArray372[local151], this.aShortArray61[triangle]);
			} else {
				Rasteriser.method2549(anIntArray361[a], anIntArray361[b], anIntArray361[c], anIntArray379[a], anIntArray379[b], anIntArray379[c], this.anIntArray345[triangle], this.anIntArray346[triangle], this.anIntArray342[triangle], anIntArray370[local141], anIntArray370[local146], anIntArray370[local151], anIntArray367[local141], anIntArray367[local146], anIntArray367[local151], anIntArray372[local141], anIntArray372[local146], anIntArray372[local151], this.aShortArray61[triangle]);
			}
		} else if (this.anIntArray342[triangle] == -1) {
			Rasteriser.method2550(anIntArray361[a], anIntArray361[b], anIntArray361[c], anIntArray379[a], anIntArray379[b], anIntArray379[c], ColorUtils.HSL_TO_RGB[this.anIntArray345[triangle] & 0xFFFF]);
		} else {
			Rasteriser.method2543(anIntArray361[a], anIntArray361[b], anIntArray361[c], anIntArray379[a], anIntArray379[b], anIntArray379[c], this.anIntArray345[triangle] & 0xFFFF, this.anIntArray346[triangle] & 0xFFFF, this.anIntArray342[triangle] & 0xFFFF);
		}
	}
	...
	public void method3822(@OriginalArg(1) int yAngle, @OriginalArg(2) int zAngle, @OriginalArg(3) int xAngle, @OriginalArg(4) int xOffset, @OriginalArg(5) int yOffset, @OriginalArg(6) int zOffset, @OriginalArg(7) long key) {
		try {
			...
			@Pc(6) int local6 = Rasteriser.anInt3125;
			@Pc(8) int local8 = Rasteriser.anInt3126;
			@Pc(12) int local12 = MathUtils.SINE[0];
			@Pc(16) int local16 = MathUtils.COSINE[0];
			@Pc(20) int sineY = MathUtils.SINE[yAngle];
			@Pc(24) int cosineY = MathUtils.COSINE[yAngle];
			@Pc(28) int sineZ = MathUtils.SINE[zAngle];
			@Pc(32) int cosineZ = MathUtils.COSINE[zAngle];
			@Pc(36) int sineX = MathUtils.SINE[xAngle];
			@Pc(40) int cosineX = MathUtils.COSINE[xAngle];
			@Pc(50) int local50 = yOffset * sineX + zOffset * cosineX >> 16;
			for (@Pc(52) int i = 0; i < this.vertexCount; i++) {
				@Pc(61) int x = this.vertexX[i];
				@Pc(66) int y = this.vertexY[i];
				@Pc(71) int z = this.vertexZ[i];
				if (zAngle != 0) {
					@Pc(83) int rotatedX = y * sineZ + x * cosineZ >> 16;
					y = y * cosineZ - x * sineZ >> 16;
					x = rotatedX;
				}
				if (yAngle != 0) {
					@Pc(131) int rotatedX = z * sineY + x * cosineY >> 16;
					z = z * cosineY - x * sineY >> 16;
					x = rotatedX;
				}
				@Pc(147) int x2 = x + xOffset;
				@Pc(151) int y2 = y + yOffset;
				@Pc(155) int z2 = z + zOffset;
				@Pc(165) int rotatedY = y2 * cosineX - z2 * sineX >> 16;
				z2 = y2 * sineX + z2 * cosineX >> 16;
				anIntArray376[i] = z2 - local50;
				anIntArray379[i] = local6 + (x2 << 9) / z2;
				anIntArray361[i] = local8 + (rotatedY << 9) / z2;
				if (this.anInt3437 > 0) {
					anIntArray370[i] = x2;
					anIntArray367[i] = rotatedY;
					anIntArray372[i] = z2;
				}
			}
			this.method2902(false, key >= 0L, key, this.boundingSphereRadius, this.boundingSphereRadius << 1, null);
	...
	public Model method3833(@OriginalArg(0) boolean shareAlpha, @OriginalArg(1) boolean shareColors, @OriginalArg(2) boolean shareNormals) {
		...
		if (!shareColors && aShortArray67.length < this.triangleCount) {
			anIntArray373 = new int[this.triangleCount + 100];
			anIntArray364 = new int[this.triangleCount + 100];
			anIntArray359 = new int[this.triangleCount + 100];
			aShortArray67 = new short[this.triangleCount + 100];
		}
		return this.method2908(shareAlpha, shareColors, aClass53_Sub4_Sub1_3, aByteArray46, aShortArray67, anIntArray373, anIntArray364, anIntArray359);
	}
	...
	public Model method3836(@OriginalArg(0) boolean shareAlpha, @OriginalArg(1) boolean shareColors, @OriginalArg(2) boolean shareNormals) {
		...
		if (!shareColors && aShortArray66.length < this.triangleCount) {
			anIntArray355 = new int[this.triangleCount + 100];
			anIntArray356 = new int[this.triangleCount + 100];
			anIntArray354 = new int[this.triangleCount + 100];
			aShortArray66 = new short[this.triangleCount + 100];
		}
		return this.method2908(shareAlpha, shareColors, aClass53_Sub4_Sub1_2, aByteArray45, aShortArray66, anIntArray355, anIntArray356, anIntArray354);
	}

	@OriginalMember(owner = "client!na", name = "e", descriptor = "(I)V")
	private void method2907(@OriginalArg(0) int triangle) {
		@Pc(1) int local1 = Rasteriser.anInt3125;
		@Pc(3) int local3 = Rasteriser.anInt3126;
		@Pc(5) int local5 = 0;
		@Pc(10) int a = this.triangleVertexA[triangle];
		@Pc(15) int b = this.triangleVertexB[triangle];
		@Pc(20) int c = this.triangleVertexC[triangle];
		@Pc(24) int local24 = anIntArray372[a];
		@Pc(28) int local28 = anIntArray372[b];
		@Pc(32) int local32 = anIntArray372[c];
		if (this.triangleAlpha == null) {
			Rasteriser.alpha = 0;
		} else {
			Rasteriser.alpha = this.triangleAlpha[triangle] & 0xFF;
		...
		if (local24 >= 50) {
			anIntArray381[0] = anIntArray379[a];
			anIntArray377[0] = anIntArray361[a];
			local5++;
			anIntArray380[0] = this.anIntArray345[triangle] & 0xFFFF;
		} else {
			@Pc(75) int local75 = anIntArray370[a];
			@Pc(79) int local79 = anIntArray367[a];
			@Pc(86) int local86 = this.anIntArray345[triangle] & 0xFFFF;
			if (local32 >= 50) {
				@Pc(99) int local99 = (50 - local24) * MathUtils.anIntArray300[local32 - local24];
				anIntArray381[0] = local1 + (local75 + ((anIntArray370[c] - local75) * local99 >> 16) << 9) / 50;
				anIntArray377[0] = local3 + (local79 + ((anIntArray367[c] - local79) * local99 >> 16) << 9) / 50;
				local5++;
				anIntArray380[0] = local86 + (((this.anIntArray342[triangle] & 0xFFFF) - local86) * local99 >> 16);
			}
			if (local28 >= 50) {
				@Pc(170) int local170 = (50 - local24) * MathUtils.anIntArray300[local28 - local24];
				anIntArray381[local5] = local1 + (local75 + ((anIntArray370[b] - local75) * local170 >> 16) << 9) / 50;
				anIntArray377[local5] = local3 + (local79 + ((anIntArray367[b] - local79) * local170 >> 16) << 9) / 50;
				anIntArray380[local5++] = local86 + (((this.anIntArray346[triangle] & 0xFFFF) - local86) * local170 >> 16);
			}
		}
		if (local28 >= 50) {
			anIntArray381[local5] = anIntArray379[b];
			anIntArray377[local5] = anIntArray361[b];
			anIntArray380[local5++] = this.anIntArray346[triangle] & 0xFFFF;
		} else {
			@Pc(258) int local258 = anIntArray370[b];
			@Pc(262) int local262 = anIntArray367[b];
			@Pc(269) int local269 = this.anIntArray346[triangle] & 0xFFFF;
			if (local24 >= 50) {
				@Pc(282) int local282 = (50 - local28) * MathUtils.anIntArray300[local24 - local28];
				anIntArray381[local5] = local1 + (local258 + ((anIntArray370[a] - local258) * local282 >> 16) << 9) / 50;
				anIntArray377[local5] = local3 + (local262 + ((anIntArray367[a] - local262) * local282 >> 16) << 9) / 50;
				anIntArray380[local5++] = local269 + (((this.anIntArray345[triangle] & 0xFFFF) - local269) * local282 >> 16);
			}
			if (local32 >= 50) {
				@Pc(353) int local353 = (50 - local28) * MathUtils.anIntArray300[local32 - local28];
				anIntArray381[local5] = local1 + (local258 + ((anIntArray370[c] - local258) * local353 >> 16) << 9) / 50;
				anIntArray377[local5] = local3 + (local262 + ((anIntArray367[c] - local262) * local353 >> 16) << 9) / 50;
				anIntArray380[local5++] = local269 + (((this.anIntArray342[triangle] & 0xFFFF) - local269) * local353 >> 16);
			}
		}
		if (local32 >= 50) {
			anIntArray381[local5] = anIntArray379[c];
			anIntArray377[local5] = anIntArray361[c];
			anIntArray380[local5++] = this.anIntArray342[triangle] & 0xFFFF;
		} else {
			@Pc(441) int local441 = anIntArray370[c];
			@Pc(445) int local445 = anIntArray367[c];
			@Pc(452) int local452 = this.anIntArray342[triangle] & 0xFFFF;
			if (local28 >= 50) {
				@Pc(465) int local465 = (50 - local32) * MathUtils.anIntArray300[local28 - local32];
				anIntArray381[local5] = local1 + (local441 + ((anIntArray370[b] - local441) * local465 >> 16) << 9) / 50;
				anIntArray377[local5] = local3 + (local445 + ((anIntArray367[b] - local445) * local465 >> 16) << 9) / 50;
				anIntArray380[local5++] = local452 + (((this.anIntArray346[triangle] & 0xFFFF) - local452) * local465 >> 16);
			}
			if (local24 >= 50) {
				@Pc(536) int local536 = (50 - local32) * MathUtils.anIntArray300[local24 - local32];
				anIntArray381[local5] = local1 + (local441 + ((anIntArray370[a] - local441) * local536 >> 16) << 9) / 50;
				anIntArray377[local5] = local3 + (local445 + ((anIntArray367[a] - local445) * local536 >> 16) << 9) / 50;
				anIntArray380[local5++] = local452 + (((this.anIntArray345[triangle] & 0xFFFF) - local452) * local536 >> 16);
			}
		}
		@Pc(598) int local598 = anIntArray381[0];
		@Pc(602) int local602 = anIntArray381[1];
		@Pc(606) int local606 = anIntArray381[2];
		@Pc(610) int local610 = anIntArray377[0];
		@Pc(614) int local614 = anIntArray377[1];
		@Pc(618) int local618 = anIntArray377[2];
		Rasteriser.aBoolean217 = false;
		if (local5 == 3) {
			if (local598 < 0 || local602 < 0 || local606 < 0 || local598 > Rasteriser.anInt3129 || local602 > Rasteriser.anInt3129 || local606 > Rasteriser.anInt3129) {
			...
			if (this.aShortArray61 != null && this.aShortArray61[triangle] != -1) {
				...
				if (this.aByteArray43 == null || this.aByteArray43[triangle] == -1) {
					...
					@Pc(704) int local704 = this.aByteArray43[triangle] & 0xFF;
					local709 = this.anIntArray351[local704];
					local714 = this.anIntArray353[local704];
					local719 = this.anIntArray341[local704];
				}
				if (this.anIntArray342[triangle] == -1) {
					Rasteriser.method2549(local610, local614, local618, local598, local602, local606, this.anIntArray345[triangle], this.anIntArray345[triangle], this.anIntArray345[triangle], anIntArray370[local709], anIntArray370[local714], anIntArray370[local719], anIntArray367[local709], anIntArray367[local714], anIntArray367[local719], anIntArray372[local709], anIntArray372[local714], anIntArray372[local719], this.aShortArray61[triangle]);
				} else {
					Rasteriser.method2549(local610, local614, local618, local598, local602, local606, anIntArray380[0], anIntArray380[1], anIntArray380[2], anIntArray370[local709], anIntArray370[local714], anIntArray370[local719], anIntArray367[local709], anIntArray367[local714], anIntArray367[local719], anIntArray372[local709], anIntArray372[local714], anIntArray372[local719], this.aShortArray61[triangle]);
				}
			} else if (this.anIntArray342[triangle] == -1) {
				Rasteriser.method2550(local610, local614, local618, local598, local602, local606, ColorUtils.HSL_TO_RGB[this.anIntArray345[triangle] & 0xFFFF]);
			} else {
				Rasteriser.method2543(local610, local614, local618, local598, local602, local606, anIntArray380[0], anIntArray380[1], anIntArray380[2]);
			}
		}
		if (local5 != 4) {
			return;
		}
		if (local598 < 0 || local602 < 0 || local606 < 0 || local598 > Rasteriser.anInt3129 || local602 > Rasteriser.anInt3129 || local606 > Rasteriser.anInt3129 || anIntArray381[3] < 0 || anIntArray381[3] > Rasteriser.anInt3129) {
			Rasteriser.aBoolean217 = true;
		}
		if (this.aShortArray61 != null && this.aShortArray61[triangle] != -1) {
			@Pc(962) int local962;
			...
			if (this.aByteArray43 == null || this.aByteArray43[triangle] == -1) {
				...
				@Pc(957) int local957 = this.aByteArray43[triangle] & 0xFF;
				local962 = this.anIntArray351[local957];
				local967 = this.anIntArray353[local957];
				local972 = this.anIntArray341[local957];
			}
			@Pc(984) short local984 = this.aShortArray61[triangle];
			if (this.anIntArray342[triangle] == -1) {
				Rasteriser.method2549(local610, local614, local618, local598, local602, local606, this.anIntArray345[triangle], this.anIntArray345[triangle], this.anIntArray345[triangle], anIntArray370[local962], anIntArray370[local967], anIntArray370[local972], anIntArray367[local962], anIntArray367[local967], anIntArray367[local972], anIntArray372[local962], anIntArray372[local967], anIntArray372[local972], local984);
				Rasteriser.method2549(local610, local618, anIntArray377[3], local598, local606, anIntArray381[3], this.anIntArray345[triangle], this.anIntArray345[triangle], this.anIntArray345[triangle], anIntArray370[local962], anIntArray370[local967], anIntArray370[local972], anIntArray367[local962], anIntArray367[local967], anIntArray367[local972], anIntArray372[local962], anIntArray372[local967], anIntArray372[local972], local984);
			} else {
				Rasteriser.method2549(local610, local614, local618, local598, local602, local606, anIntArray380[0], anIntArray380[1], anIntArray380[2], anIntArray370[local962], anIntArray370[local967], anIntArray370[local972], anIntArray367[local962], anIntArray367[local967], anIntArray367[local972], anIntArray372[local962], anIntArray372[local967], anIntArray372[local972], local984);
				Rasteriser.method2549(local610, local618, anIntArray377[3], local598, local606, anIntArray381[3], anIntArray380[0], anIntArray380[2], anIntArray380[3], anIntArray370[local962], anIntArray370[local967], anIntArray370[local972], anIntArray367[local962], anIntArray367[local967], anIntArray367[local972], anIntArray372[local962], anIntArray372[local967], anIntArray372[local972], local984);
			}
		} else if (this.anIntArray342[triangle] == -1) {
			@Pc(883) int local883 = ColorUtils.HSL_TO_RGB[this.anIntArray345[triangle] & 0xFFFF];
			Rasteriser.method2550(local610, local614, local618, local598, local602, local606, local883);
			Rasteriser.method2550(local610, local618, anIntArray377[3], local598, local606, anIntArray381[3], local883);
		} else {
			Rasteriser.method2543(local610, local614, local618, local598, local602, local606, anIntArray380[0], anIntArray380[1], anIntArray380[2]);
			Rasteriser.method2543(local610, local618, anIntArray377[3], local598, local606, anIntArray381[3], anIntArray380[0], anIntArray380[2], anIntArray380[3]);
		}
	}

	@OriginalMember(owner = "client!na", name = "a", descriptor = "(ZZLclient!na;[B[S[I[I[I)Lclient!vg;")
	private Model method2908(@OriginalArg(0) boolean shareAlpha, @OriginalArg(1) boolean shareColors, @OriginalArg(2) SoftwareModel arg2, @OriginalArg(3) byte[] arg3, @OriginalArg(4) short[] arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7) {
		...
		for (@Pc(47) int i = 0; i < this.vertexCount; i++) {
			arg2.vertexX[i] = this.vertexX[i];
			arg2.vertexY[i] = this.vertexY[i];
			arg2.vertexZ[i] = this.vertexZ[i];
		}
		if (shareAlpha) {
			...
			if (this.triangleAlpha == null) {
				for (@Pc(92) int i = 0; i < this.triangleCount; i++) {
					arg2.triangleAlpha[i] = 0;
				}
			} else {
				for (@Pc(106) int i = 0; i < this.triangleCount; i++) {
					arg2.triangleAlpha[i] = this.triangleAlpha[i];
				}
			}
		}
		if (shareColors) {
			...
			for (@Pc(153) int i = 0; i < this.triangleCount; i++) {
				arg2.triangleColors[i] = this.triangleColors[i];
				arg2.anIntArray345[i] = this.anIntArray345[i];
				arg2.anIntArray346[i] = this.anIntArray346[i];
				arg2.anIntArray342[i] = this.anIntArray342[i];
			}
		}
	...
	protected void transform(@OriginalArg(0) int type, @OriginalArg(1) int[] bone, @OriginalArg(2) int x, @OriginalArg(3) int y, @OriginalArg(4) int z, @OriginalArg(5) boolean arg5) {
		...
		if (type == 0) {
			...
			for (@Pc(14) int local14 = 0; local14 < local2; local14++) {
				@Pc(21) int local21 = bone[local14];
			...
			for (@Pc(100) int local100 = 0; local100 < local2; local100++) {
				@Pc(107) int local107 = bone[local100];
				if (local107 < this.boneVertices.length) {
					@Pc(117) int[] local117 = this.boneVertices[local107];
			...
			for (@Pc(161) int local161 = 0; local161 < local2; local161++) {
				@Pc(168) int local168 = bone[local161];
				if (local168 < this.boneVertices.length) {
					@Pc(178) int[] local178 = this.boneVertices[local168];
					for (@Pc(180) int local180 = 0; local180 < local178.length; local180++) {
						...
						local190[local188] -= originX;
						local190 = this.vertexY;
						local190[local188] -= originY;
						local190 = this.vertexZ;
						local190[local188] -= originZ;
						if (z != 0) {
							@Pc(218) int local218 = MathUtils.SINE[z];
							@Pc(222) int local222 = MathUtils.COSINE[z];
						...
						if (x != 0) {
							@Pc(272) int local272 = MathUtils.SINE[x];
							@Pc(276) int local276 = MathUtils.COSINE[x];
						...
						if (y != 0) {
							@Pc(326) int local326 = MathUtils.SINE[y];
							@Pc(330) int local330 = MathUtils.COSINE[y];
						...
						local376[local188] += originX;
						local376 = this.vertexY;
						local376[local188] += originY;
						local376 = this.vertexZ;
						local376[local188] += originZ;
					}
				}
			}
		} else if (type == 3) {
			for (@Pc(408) int local408 = 0; local408 < local2; local408++) {
				@Pc(415) int local415 = bone[local408];
				if (local415 < this.boneVertices.length) {
					@Pc(425) int[] local425 = this.boneVertices[local415];
					for (@Pc(427) int local427 = 0; local427 < local425.length; local427++) {
						...
						local437[local435] -= originX;
						local437 = this.vertexY;
						local437[local435] -= originY;
						local437 = this.vertexZ;
						local437[local435] -= originZ;
						this.vertexX[local435] = this.vertexX[local435] * x / 128;
						this.vertexY[local435] = this.vertexY[local435] * y / 128;
						this.vertexZ[local435] = this.vertexZ[local435] * z / 128;
			...
			if (this.boneTriangles != null && this.triangleAlpha != null) {
				for (@Pc(535) int local535 = 0; local535 < local2; local535++) {
					@Pc(542) int local542 = bone[local535];
					if (local542 < this.boneTriangles.length) {
						@Pc(552) int[] local552 = this.boneTriangles[local542];
						for (@Pc(554) int local554 = 0; local554 < local552.length; local554++) {
							@Pc(562) int local562 = local552[local554];
							@Pc(573) int local573 = (this.triangleAlpha[local562] & 0xFF) + x * 8;
							if (local573 < 0) {
								local573 = 0;
			...
			for (@Pc(602) int local602 = 0; local602 < local2; local602++) {
				@Pc(609) int local609 = bone[local602];
				if (local609 < this.boneTriangles.length) {
					@Pc(619) int[] local619 = this.boneTriangles[local609];
					for (@Pc(621) int local621 = 0; local621 < local619.length; local621++) {
						...
						local642 = local642 + x & 0x3F;
						@Pc(662) int local662 = local648 + y;
						if (local662 < 0) {
							local662 = 0;
						} else if (local662 > 7) {
							local662 = 7;
						}
						@Pc(676) int local676 = local652 + z;
						if (local676 < 0) {
							local676 = 0;
	...
	public void resize(@OriginalArg(0) int x, @OriginalArg(1) int y, @OriginalArg(2) int z) {
		for (@Pc(1) int local1 = 0; local1 < this.vertexCount; local1++) {
			...
			this.vertexZ[local1] = this.vertexZ[local1] * z / 128;
		}
		this.boundsValid = false;
	}
	...
	public void method2911(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6) {
		try {
			...
			for (@Pc(52) int local52 = 0; local52 < this.vertexCount; local52++) {
				...
				anIntArray376[local52] = local155 - local50;
				anIntArray379[local52] = local6 + (local147 << 9) / arg6;
				anIntArray361[local52] = local8 + (local165 << 9) / arg6;
				if (this.anInt3437 > 0) {
					anIntArray370[local52] = local147;
					anIntArray367[local52] = local165;
					anIntArray372[local52] = local155;
				}
			}
	...
	protected void transform(@OriginalArg(0) int type, @OriginalArg(1) int[] bones, @OriginalArg(2) int x, @OriginalArg(3) int y, @OriginalArg(4) int z, @OriginalArg(5) boolean arg5, @OriginalArg(6) int parts, @OriginalArg(7) int[] arg7) {
		...
		if (type == 0) {
			...
			originY = 0;
			originZ = 0;
			for (@Pc(14) int i = 0; i < bonesLen; i++) {
				@Pc(21) int bone = bones[i];
				if (bone < this.boneVertices.length) {
					@Pc(31) int[] vertices = this.boneVertices[bone];
					for (@Pc(33) int j = 0; j < vertices.length; j++) {
						@Pc(41) int vertex = vertices[j];
						if (this.vertexSources == null || (parts & this.vertexSources[vertex]) != 0) {
							originX += this.vertexX[vertex];
							originY += this.vertexY[vertex];
							originZ += this.vertexZ[vertex];
							count++;
						}
					}
				}
			...
			if (arg7 != null) {
				@Pc(135) int local135 = arg7[0] * x + arg7[1] * y + arg7[2] * z + 16384 >> 15;
				@Pc(157) int local157 = arg7[3] * x + arg7[4] * y + arg7[5] * z + 16384 >> 15;
				@Pc(179) int local179 = arg7[6] * x + arg7[7] * y + arg7[8] * z + 16384 >> 15;
				x = local135;
				y = local157;
				z = local179;
			}
			for (@Pc(187) int i = 0; i < bonesLen; i++) {
				@Pc(194) int bone = bones[i];
				if (bone < this.boneVertices.length) {
					@Pc(204) int[] vertices = this.boneVertices[bone];
					for (@Pc(206) int j = 0; j < vertices.length; j++) {
						@Pc(214) int vertex = vertices[j];
						if (this.vertexSources == null || (parts & this.vertexSources[vertex]) != 0) {
			...
			if (arg7 == null) {
				for (@Pc(1051) int local1051 = 0; local1051 < bonesLen; local1051++) {
					@Pc(1058) int local1058 = bones[local1051];
					if (local1058 < this.boneVertices.length) {
						@Pc(1068) int[] local1068 = this.boneVertices[local1058];
						for (@Pc(1070) int local1070 = 0; local1070 < local1068.length; local1070++) {
							@Pc(1078) int local1078 = local1068[local1070];
							if (this.vertexSources == null || (parts & this.vertexSources[local1078]) != 0) {
								@Pc(1091) int[] local1091 = this.vertexX;
								local1091[local1078] -= originX;
								local1091 = this.vertexY;
								local1091[local1078] -= originY;
								local1091 = this.vertexZ;
								local1091[local1078] -= originZ;
								if (z != 0) {
									@Pc(1119) int local1119 = MathUtils.SINE[z];
									@Pc(1123) int local1123 = MathUtils.COSINE[z];
								...
								if (x != 0) {
									@Pc(1173) int local1173 = MathUtils.SINE[x];
									@Pc(1177) int local1177 = MathUtils.COSINE[x];
								...
								if (y != 0) {
									@Pc(1227) int local1227 = MathUtils.SINE[y];
									@Pc(1231) int local1231 = MathUtils.COSINE[y];
								...
								local1277[local1078] += originX;
								local1277 = this.vertexY;
								local1277[local1078] += originY;
								local1277 = this.vertexZ;
								local1277[local1078] += originZ;
							}
						}
					}
				}
				...
				if (aBoolean247) {
					@Pc(307) int local307 = arg7[0] * originX + arg7[3] * originY + arg7[6] * originZ + 16384 >> 15;
					@Pc(329) int local329 = arg7[1] * originX + arg7[4] * originY + arg7[7] * originZ + 16384 >> 15;
					@Pc(351) int local351 = arg7[2] * originX + arg7[5] * originY + arg7[8] * originZ + 16384 >> 15;
					local307 += local275;
					local329 += local279;
					local351 += local283;
					originX = local307;
				...
				@Pc(380) int local380 = MathUtils.COSINE[x] >> 1;
				@Pc(386) int local386 = MathUtils.SINE[x] >> 1;
				@Pc(392) int local392 = MathUtils.COSINE[y] >> 1;
				@Pc(398) int local398 = MathUtils.SINE[y] >> 1;
				@Pc(404) int local404 = MathUtils.COSINE[z] >> 1;
				@Pc(410) int local410 = MathUtils.SINE[z] >> 1;
				...
				@Pc(579) int local579 = local374[3] * -originX + local374[4] * -originY + local374[5] * -originZ + 16384 >> 15;
				@Pc(604) int local604 = local374[6] * -originX + local374[7] * -originY + local374[8] * -originZ + 16384 >> 15;
				@Pc(608) int local608 = local554 + originX;
				@Pc(612) int local612 = local579 + originY;
				@Pc(616) int local616 = local604 + originZ;
				...
				local850 += local267;
				local872 += local271;
				for (@Pc(886) int local886 = 0; local886 < bonesLen; local886++) {
					@Pc(893) int local893 = bones[local886];
					if (local893 < this.boneVertices.length) {
						...
						for (@Pc(905) int local905 = 0; local905 < local903.length; local905++) {
							...
							if (this.vertexSources == null || (parts & this.vertexSources[local913]) != 0) {
			...
			if (arg7 == null) {
				for (@Pc(1926) int local1926 = 0; local1926 < bonesLen; local1926++) {
					@Pc(1933) int local1933 = bones[local1926];
					if (local1933 < this.boneVertices.length) {
						@Pc(1943) int[] local1943 = this.boneVertices[local1933];
						for (@Pc(1945) int local1945 = 0; local1945 < local1943.length; local1945++) {
							@Pc(1953) int local1953 = local1943[local1945];
							if (this.vertexSources == null || (parts & this.vertexSources[local1953]) != 0) {
								@Pc(1966) int[] local1966 = this.vertexX;
								local1966[local1953] -= originX;
								local1966 = this.vertexY;
								local1966[local1953] -= originY;
								local1966 = this.vertexZ;
								local1966[local1953] -= originZ;
								this.vertexX[local1953] = this.vertexX[local1953] * x / 128;
								this.vertexY[local1953] = this.vertexY[local1953] * y / 128;
								this.vertexZ[local1953] = this.vertexZ[local1953] * z / 128;
				...
				if (aBoolean247) {
					@Pc(1357) int local1357 = arg7[0] * originX + arg7[3] * originY + arg7[6] * originZ + 16384 >> 15;
					@Pc(1379) int local1379 = arg7[1] * originX + arg7[4] * originY + arg7[7] * originZ + 16384 >> 15;
					@Pc(1401) int local1401 = arg7[2] * originX + arg7[5] * originY + arg7[8] * originZ + 16384 >> 15;
					local1357 += local1325;
					local1379 += local1329;
					local1401 += local1333;
					originX = local1357;
				...
				@Pc(1427) int local1427 = x << 15 >> 7;
				@Pc(1433) int local1433 = y << 15 >> 7;
				@Pc(1439) int local1439 = z << 15 >> 7;
				@Pc(1448) int local1448 = local1427 * -originX + 16384 >> 15;
				@Pc(1457) int local1457 = local1433 * -originY + 16384 >> 15;
				@Pc(1466) int local1466 = local1439 * -originZ + 16384 >> 15;
				@Pc(1470) int local1470 = local1448 + originX;
				@Pc(1474) int local1474 = local1457 + originY;
				@Pc(1478) int local1478 = local1466 + originZ;
				...
				local1725 += local1317;
				local1747 += local1321;
				for (@Pc(1761) int local1761 = 0; local1761 < bonesLen; local1761++) {
					@Pc(1768) int local1768 = bones[local1761];
					if (local1768 < this.boneVertices.length) {
						@Pc(1778) int[] local1778 = this.boneVertices[local1768];
						for (@Pc(1780) int local1780 = 0; local1780 < local1778.length; local1780++) {
							@Pc(1788) int local1788 = local1778[local1780];
							if (this.vertexSources == null || (parts & this.vertexSources[local1788]) != 0) {
			...
			if (this.boneTriangles != null && this.triangleAlpha != null) {
				for (@Pc(2064) int local2064 = 0; local2064 < bonesLen; local2064++) {
					@Pc(2071) int local2071 = bones[local2064];
					if (local2071 < this.boneTriangles.length) {
						@Pc(2081) int[] local2081 = this.boneTriangles[local2071];
						for (@Pc(2083) int local2083 = 0; local2083 < local2081.length; local2083++) {
							@Pc(2091) int local2091 = local2081[local2083];
							if (this.triangleSources == null || (parts & this.triangleSources[local2091]) != 0) {
								@Pc(2113) int local2113 = (this.triangleAlpha[local2091] & 0xFF) + x * 8;
								if (local2113 < 0) {
									local2113 = 0;
			...
			for (@Pc(2142) int local2142 = 0; local2142 < bonesLen; local2142++) {
				@Pc(2149) int local2149 = bones[local2142];
				if (local2149 < this.boneTriangles.length) {
					@Pc(2159) int[] local2159 = this.boneTriangles[local2149];
					for (@Pc(2161) int local2161 = 0; local2161 < local2159.length; local2161++) {
						@Pc(2169) int local2169 = local2159[local2161];
						if (this.triangleSources == null || (parts & this.triangleSources[local2169]) != 0) {
							...
							local2193 = local2193 + x & 0x3F;
							@Pc(2213) int local2213 = local2199 + y;
							if (local2213 < 0) {
								local2213 = 0;
							} else if (local2213 > 7) {
								local2213 = 7;
							}
							@Pc(2227) int local2227 = local2203 + z;
							if (local2227 < 0) {
								local2227 = 0;
		...
		for (@Pc(1) int local1 = 0; local1 < this.triangleCount; local1++) {
			...
			if (local15 == -1) {
				...
				if (this.anIntArray342[local1] == -1) {
					...
					this.anIntArray345[local1] = local38 | method2912(local25, local38 >> 17);
				} else if (this.anIntArray342[local1] != -2) {
					@Pc(63) int local63 = this.anIntArray345[local1] & 0xFFFE0000;
					this.anIntArray345[local1] = local63 | method2912(local25, local63 >> 17);
					local63 = this.anIntArray346[local1] & 0xFFFE0000;
					this.anIntArray346[local1] = local63 | method2912(local25, local63 >> 17);
					local63 = this.anIntArray342[local1] & 0xFFFE0000;
					this.anIntArray342[local1] = local63 | method2912(local25, local63 >> 17);
				}
			}
		}
	}
	...
	protected void transform(@OriginalArg(0) int type, @OriginalArg(1) int x, @OriginalArg(2) int y, @OriginalArg(3) int z) {
		if (type == 0) {
			...
			for (@Pc(72) int i = 0; i < this.vertexCount; i++) {
				@Pc(78) int[] vertex = this.vertexX;
				vertex[i] += x;
				vertex = this.vertexY;
				vertex[i] += y;
				vertex = this.vertexZ;
			...
			for (@Pc(108) int i = 0; i < this.vertexCount; i++) {
				@Pc(114) int[] vertex = this.vertexX;
				vertex[i] -= originX;
				vertex = this.vertexY;
				vertex[i] -= originY;
				vertex = this.vertexZ;
				vertex[i] -= originZ;
				if (z != 0) {
					@Pc(142) int sine = MathUtils.SINE[z];
					@Pc(146) int cosine = MathUtils.COSINE[z];
					@Pc(164) int rotatedX = this.vertexY[i] * sine + this.vertexX[i] * cosine + 32767 >> 16;
					this.vertexY[i] = this.vertexY[i] * cosine + 32767 - this.vertexX[i] * sine >> 16;
					this.vertexX[i] = rotatedX;
				}
				if (x != 0) {
					@Pc(196) int sine = MathUtils.SINE[x];
					@Pc(200) int cosine = MathUtils.COSINE[x];
					@Pc(218) int rotatedY = this.vertexY[i] * cosine + 32767 - this.vertexZ[i] * sine >> 16;
					this.vertexZ[i] = this.vertexY[i] * sine + this.vertexZ[i] * cosine + 32767 >> 16;
					this.vertexY[i] = rotatedY;
				}
				if (y != 0) {
					@Pc(250) int sine = MathUtils.SINE[y];
					@Pc(254) int cosine = MathUtils.COSINE[y];
					@Pc(272) int rotatedX = this.vertexZ[i] * sine + this.vertexX[i] * cosine + 32767 >> 16;
					this.vertexZ[i] = this.vertexZ[i] * cosine + 32767 - this.vertexX[i] * sine >> 16;
					this.vertexX[i] = rotatedX;
				}
				@Pc(300) int[] vertex2 = this.vertexX;
				vertex2[i] += originX;
				vertex2 = this.vertexY;
				vertex2[i] += originY;
				vertex2 = this.vertexZ;
				vertex2[i] += originZ;
			}
		} else if (type == 3) {
			for (@Pc(330) int i = 0; i < this.vertexCount; i++) {
				@Pc(336) int[] vertex = this.vertexX;
				vertex[i] -= originX;
				vertex = this.vertexY;
				vertex[i] -= originY;
				vertex = this.vertexZ;
			...
			for (@Pc(426) int i = 0; i < this.triangleCount; i++) {
				@Pc(441) int alpha = (this.triangleAlpha[i] & 0xFF) + x * 8;
				if (alpha < 0) {
					alpha = 0;
				} else if (alpha > 255) {
					alpha = 255;
				}
				this.triangleAlpha[i] = (byte) alpha;
			}
		} else if (type == 7) {
			for (@Pc(465) int i = 0; i < this.triangleCount; i++) {
				@Pc(476) int color = this.triangleColors[i] & 0xFFFF;
				@Pc(482) int h = color >> 10 & 0x3F;
				@Pc(488) int s = color >> 7 & 0x7;
				@Pc(492) int l = color & 0x7F;
				h = h + x & 0x3F;
				@Pc(502) int s2 = s + y;
				if (s2 < 0) {
					s2 = 0;
				...
				this.triangleColors[i] = (short) (h << 10 | s2 << 7 | l2);
			}
			this.aBoolean245 = true;
		}
	}
