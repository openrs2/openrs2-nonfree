...
public final class Static20 {
	...
	private static void method2406(@OriginalArg(0) Class4_Sub10 arg0) {
		label83:
		while (true) {
			if (arg0.anInt5709 < arg0.aByteArray71.length) {
				@Pc(7) boolean local7 = false;
				@Pc(9) int local9 = 0;
				@Pc(11) int local11 = 0;
				if (arg0.method4629() == 1) {
					local7 = true;
					local9 = arg0.method4629();
					local11 = arg0.method4629();
				}
				@Pc(30) int local30 = arg0.method4629();
				@Pc(34) int local34 = arg0.method4629();
					...
					while (true) {
						...
						for (@Pc(79) int local79 = 0; local79 < 64; local79++) {
							if (!local7 || local74 >= local9 * 8 && local74 < local9 * 8 + 8 && local79 >= local11 * 8 && local79 < local11 * 8 + 8) {
								@Pc(113) byte local113 = arg0.method4637();
								if (local113 != 0) {
									...
									@Pc(146) byte local146 = arg0.method4637();
				...
				while (true) {
					...
					@Pc(191) byte local191 = arg0.method4637();
					if (local191 != 0) {
						arg0.anInt5709++;
					}
					local180++;
	...
	private static void method2407(@OriginalArg(0) Class4_Sub10 arg0, @OriginalArg(1) boolean arg1) {
		label125:
		while (true) {
			if (arg0.anInt5709 < arg0.aByteArray71.length) {
				@Pc(7) boolean local7 = false;
				...
				if (local40 >= 0 && local50 - 63 >= 0 && local40 + 63 < Static3.anInt2965 && local50 < Static3.anInt2960) {
					...
					while (true) {
						...
						for (@Pc(79) int local79 = 0; local79 < 64; local79++) {
							if (!local7 || local74 >= local9 * 8 && local74 < local9 * 8 + 8 && local79 >= local11 * 8 && local79 < local11 * 8 + 8) {
								@Pc(113) int local113 = arg0.method4629();
								if (local113 != 0) {
									if ((local113 & 0x1) == 1) {
										@Pc(125) int local125 = arg0.method4629();
									...
									if ((local113 & 0x2) == 2) {
										@Pc(162) int local162 = arg0.method4618();
									...
									if ((local113 & 0x4) == 4) {
										@Pc(198) int local198 = arg0.method4616();
										@Pc(202) int local202 = arg0.method4629();
										local198--;
	...
	private static void method1922() {
		...
		if (Static4.anInt2644 == 10) {
			...
			Static26.method2934(new Class4_Sub10(Static3.aClass58_65.method1358("underlay", Static3.aClass4_Sub3_Sub22_3.aString358)));
			Static4.anInt2644 = 30;
			Static32.method3917(true);
			Static18.method4371();
		} else if (Static4.anInt2644 == 30) {
			Static19.method2398(new Class4_Sub10(Static3.aClass58_65.method1358("overlay", Static3.aClass4_Sub3_Sub22_3.aString358)));
			Static4.anInt2644 = 40;
			Static18.method4371();
		} else if (Static4.anInt2644 == 40) {
			method2406(new Class4_Sub10(Static3.aClass58_65.method1358("overlay2", Static3.aClass4_Sub3_Sub22_3.aString358)));
			Static4.anInt2644 = 50;
			Static18.method4371();
		} else if (Static4.anInt2644 == 50) {
			method2407(new Class4_Sub10(Static3.aClass58_65.method1358("loc", Static3.aClass4_Sub3_Sub22_3.aString358)), Static7.aBoolean370);
			...
			Static6.aClass106_7 = new Class106(11, true, Static5.aCanvas115);
			Static4.anInt2644 = 73;
			Static32.method3917(true);
			Static18.method4371();
		} else if (Static4.anInt2644 == 73) {
			Static4.aClass106_3 = new Class106(12, true, Static5.aCanvas115);
			Static4.anInt2644 = 76;
			Static32.method3917(true);
			Static18.method4371();
		} else if (Static4.anInt2644 == 76) {
			Static4.aClass106_5 = new Class106(14, true, Static5.aCanvas115);
			Static4.anInt2644 = 79;
			Static32.method3917(true);
			Static18.method4371();
		} else if (Static4.anInt2644 == 79) {
			Static4.aClass106_4 = new Class106(17, true, Static5.aCanvas115);
			Static4.anInt2644 = 82;
			Static32.method3917(true);
			Static18.method4371();
		} else if (Static4.anInt2644 == 82) {
			Static1.aClass106_1 = new Class106(19, true, Static5.aCanvas115);
			Static4.anInt2644 = 85;
			Static32.method3917(true);
			Static18.method4371();
		} else if (Static4.anInt2644 == 85) {
			Static2.aClass106_2 = new Class106(22, true, Static5.aCanvas115);
			Static4.anInt2644 = 88;
			Static32.method3917(true);
			Static18.method4371();
		} else if (Static4.anInt2644 == 88) {
			Static5.aClass106_6 = new Class106(26, true, Static5.aCanvas115);
			Static4.anInt2644 = 91;
			Static32.method3917(true);
			Static18.method4371();
		} else {
			Static6.aClass106_8 = new Class106(30, true, Static5.aCanvas115);
	...
	public static void method1949() {
		...
		Static2.anInt1635 = local9.getSize().width;
		Static6.anInt4380 = local9.getSize().height;
		if (local9 == Static4.aFrame2) {
			@Pc(35) Insets local35 = Static4.aFrame2.getInsets();
			Static2.anInt1635 -= local35.left + local35.right;
			Static6.anInt4380 -= local35.bottom + local35.top;
		}
		if (Static11.method557() >= 2) {
			Static7.anInt5622 = 0;
			Static1.anInt526 = Static2.anInt1635;
			Static6.anInt4859 = 0;
			Static1.anInt690 = Static6.anInt4380;
		} else {
			Static1.anInt526 = 765;
			Static1.anInt690 = 503;
			Static6.anInt4859 = (Static2.anInt1635 - 765) / 2;
			Static7.anInt5622 = 0;
		}
		if (Static3.aBoolean138) {
			Static16.method1587(Static1.anInt526, Static1.anInt690);
		}
		Static5.aCanvas115.setSize(Static1.anInt526, Static1.anInt690);
		if (local9 == Static4.aFrame2) {
			@Pc(104) Insets local104 = Static4.aFrame2.getInsets();
			Static5.aCanvas115.setLocation(local104.left + Static6.anInt4859, Static7.anInt5622 + local104.top);
		} else {
	...
	public static Class4_Sub3_Sub23 method1961(@OriginalArg(0) int arg0) {
		...
		if (local26 != null) {
			local38.method4772(new Class4_Sub10(local26));
		}
		if (arg0 >= 32768) {
			local38.method4778();
		}
	...
	public static int method1966(@OriginalArg(0) byte[] arg0, @OriginalArg(1) String arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
