...
public final class Class4_Sub3_Sub3 extends SecondaryNode {
	...
	public final int method601(@OriginalArg(1) int arg0) {
		if (this.aClass84_3 == null) {
			...
			@Pc(17) IntNode local17 = (IntNode) this.aClass84_3.get((long) arg0);
	...
	private void method602() {
		this.aClass84_2 = new HashTable(this.aClass84_3.getBucketCount());
		for (@Pc(22) StringNode local22 = (StringNode) this.aClass84_3.head(); local22 != null; local22 = (StringNode) this.aClass84_3.next()) {
			@Pc(34) Class4_Sub22 local34 = new Class4_Sub22(local22.value, (int) local22.key);
			this.aClass84_2.put(Static24.method2682(local22.value), local34);
		}
	}
	...
	private void method603(@OriginalArg(1) Buffer arg0, @OriginalArg(2) int arg1) {
		if (arg1 == 1) {
			...
			this.aClass84_3 = new HashTable(IntUtils.clp2(local68));
			for (@Pc(78) int local78 = 0; local78 < local68; local78++) {
				...
				this.aClass84_3.put((long) local87, local99);
			}
		}
	}
	...
	public final boolean method604(@OriginalArg(1) int arg0) {
		...
		@Pc(32) IntNode local32 = (IntNode) this.aClass84_2.get((long) arg0);
		return local32 != null;
	}
	...
	public final String method606(@OriginalArg(0) int arg0) {
		if (this.aClass84_3 == null) {
			...
			@Pc(18) StringNode local18 = (StringNode) this.aClass84_3.get((long) arg0);
	...
	private void method607() {
		this.aClass84_2 = new HashTable(this.aClass84_3.getBucketCount());
		for (@Pc(24) IntNode local24 = (IntNode) this.aClass84_3.head(); local24 != null; local24 = (IntNode) this.aClass84_3.next()) {
			@Pc(33) IntNode local33 = new IntNode((int) local24.key);
			this.aClass84_2.put((long) local24.value, local33);
		}
	}
	...
	public final boolean method611(@OriginalArg(1) String arg0) {
		...
		for (@Pc(36) Class4_Sub22 local36 = (Class4_Sub22) this.aClass84_2.get(Static24.method2682(arg0)); local36 != null; local36 = (Class4_Sub22) this.aClass84_2.nextWithKey()) {
