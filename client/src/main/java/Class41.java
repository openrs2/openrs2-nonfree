			...
			for (@Pc(90) int local90 = 0; local90 < 64; local90++) {
				for (@Pc(99) int local99 = 0; local99 < 64; local99++) {
					for (@Pc(104) int local104 = 0; local104 < this.anInt3772; local104++) {
						...
						@Pc(187) int local187 = MonochromeImageCache.PERLIN_FADE[local138];
						...
						@Pc(226) int local226 = MonochromeImageCache.PERLIN_FADE[local167];
						@Pc(237) int local237;
						...
						@Pc(265) int local265 = MonochromeImageCache.PERLIN_FADE[local257];
