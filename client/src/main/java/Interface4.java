...
public interface Interface4 {
	...
	int[] method445(@OriginalArg(0) float arg0, @OriginalArg(2) int arg1);
	...
	boolean method448(@OriginalArg(0) int arg0);
	...
	Class4_Sub3_Sub14_Sub1 method452(@OriginalArg(0) boolean arg0, @OriginalArg(1) float arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3);

	@OriginalMember(owner = "client!nk", name = "g", descriptor = "(II)Z")
	boolean method453(@OriginalArg(1) int arg0);

	@OriginalMember(owner = "client!nk", name = "a", descriptor = "(BII)V")
	void method454(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1);
