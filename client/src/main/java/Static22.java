...
public final class Static22 {
	...
	public static void method4689(@OriginalArg(0) Class196 arg0, @OriginalArg(1) int arg1, @OriginalArg(3) Class4_Sub10 arg2) {
		...
		for (@Pc(57) int local57 = 0; local57 < local9.anInt4857; local57++) {
			try {
				@Pc(69) int local69 = arg2.method4629();
				if (local69 == 0 || local69 == 1 || local69 == 2) {
					@Pc(88) String local88 = arg2.method4593();
					@Pc(90) int local90 = 0;
					@Pc(94) String local94 = arg2.method4593();
					if (local69 == 1) {
						local90 = arg2.method4595();
					}
	...
	public static Class82 method2191(@OriginalArg(1) int arg0) {
		...
		if (local26 != null) {
			local30.method1806(new Class4_Sub10(local26));
		}
	...
	public static int method2285() {
		try {
			...
			if (Static7.anInt5319 == 1) {
				...
				Static3.aClass4_Sub10_Sub1_1.method4581(23);
				Static3.aClass4_Sub10_Sub1_1.method4617(local79);
				...
				@Pc(117) int local117 = Static3.aClass52_7.method1105();
				if (Static1.aClass102_1 != null) {
					Static1.aClass102_1.method2996();
				}
				if (Static6.aClass102_2 != null) {
			...
			if (Static7.anInt5319 == 2) {
				...
				Static6.anInt4617 = Static3.aClass52_7.method1105();
				Static6.anInt4617 <<= 8;
				Static6.anInt4617 += Static3.aClass52_7.method1105();
			...
			@Pc(189) int local189 = Static3.aClass52_7.method1101();
			if (local189 < 1) {
				return -1;
			}
			...
			Static3.aClass52_7.method1099(Static2.anInt1123, Static2.aByteArray10, local189);
	...
	public static void method2297() {
		...
		if (Static3.aBoolean126) {
			local11.method4604(0.0F);
			local11.method4604(1.0F);
			local11.method4604(0.0F);
			local11.method4604(0.5F);
			local11.method4604(1.0F);
			local11.method4604(0.0F);
			local11.method4604(-1.0F);
			local11.method4604(0.0F);
			...
			local11.method4632(0.0F);
			local11.method4632(1.0F);
			local11.method4632(0.0F);
			local11.method4632(0.5F);
			local11.method4632(1.0F);
			local11.method4632(0.0F);
			local11.method4632(-1.0F);
			local11.method4632(0.0F);
		...
		for (@Pc(100) int local100 = 0; local100 <= 16; local100++) {
			...
			for (@Pc(125) int local125 = 1; local125 < 16; local125++) {
				...
				if (Static3.aBoolean126) {
					local11.method4604(local159);
					local11.method4604(local141);
					local11.method4604(local150);
					local11.method4604(local96);
					local11.method4604(local98);
				} else {
					local11.method4632(local159);
					local11.method4632(local141);
					local11.method4632(local150);
					local11.method4632(local96);
					local11.method4632(local98);
				}
				local98 += 0.05882353F;
			}
			if (local100 > 0) {
				...
				if (Static3.aBoolean126) {
					...
					for (@Pc(232) int local232 = 1; local232 < 16; local232++) {
						local6.method4631(local220++);
						local6.method4631(local216++);
					}
					local6.method4631(1);
					local6.method4631(1);
				} else {
					...
					for (@Pc(266) int local266 = 1; local266 < 16; local266++) {
						local6.method4603(local220++);
						local6.method4603(local216++);
					}
					local6.method4603(1);
					local6.method4603(1);
				}
		...
		Static4.aByteBuffer9 = ByteBuffer.allocateDirect(local11.anInt5709);
		Static4.aByteBuffer9.put(local11.aByteArray71, 0, local11.anInt5709);
		Static4.aByteBuffer9.flip();
		Static4.aByteBuffer10 = ByteBuffer.allocateDirect(local6.anInt5709);
		Static4.aByteBuffer10.put(local6.aByteArray71, 0, local6.anInt5709);
	...
	public static Class4_Sub12[] method2389(@OriginalArg(0) int[][][] arg0, @OriginalArg(1) byte[][] arg1, @OriginalArg(2) float[][] arg2, @OriginalArg(3) int[][] arg3, @OriginalArg(4) int[][] arg4, @OriginalArg(5) float[][] arg5, @OriginalArg(6) byte[][] arg6, @OriginalArg(7) int[][] arg7, @OriginalArg(8) byte[][] arg8, @OriginalArg(9) int arg9, @OriginalArg(10) float[][] arg10, @OriginalArg(11) int[][] arg11, @OriginalArg(12) byte[][][] arg12, @OriginalArg(13) byte[][] arg13, @OriginalArg(15) int[][] arg14) {
		...
		for (@Pc(1502) int local1502 = 0; local1502 < local1489; local1502++) {
			local1500[local1502] = local1492[local1502].aLong212;
		}
	...
	public static Class133 method2390(@OriginalArg(1) int arg0) {
		...
		if (local28 != null) {
			local32.method3398(arg0, new Class4_Sub10(local28));
		}
