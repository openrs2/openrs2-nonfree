...
public final class Static37 {
	...
	public static Class4_Sub3_Sub14 method4676(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(4) Class144 arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		@Pc(23) int local23 = (arg2 ? 65536 : 0) + arg4 + (arg1 << 17) + (arg5 << 19);
		@Pc(34) long local34 = (long) arg0 * 3147483667L + (long) local23 * 3849834839L;
		@Pc(40) Class4_Sub3_Sub14 local40 = (Class4_Sub3_Sub14) Static5.aClass26_37.method518(local34);
		if (local40 != null) {
			return local40;
		}
		...
		if (local58 != null && !Static4.aBoolean218) {
			Static5.aClass26_37.method510(local58, local34);
		}
		return local58;
	}
	...
	public static int method4711(@OriginalArg(1) String arg0, @OriginalArg(2) int arg1, @OriginalArg(3) String arg2) {
		...
		while (local8 > local15 - local20 || local18 > local22 - local24) {
			...
			local20 = Static32.method3919(local73);
			local24 = Static32.method3919(local83);
			@Pc(105) char local105 = Static11.method523(arg1, local73);
			@Pc(110) char local110 = Static11.method523(arg1, local83);
			if (local110 != local105 && Character.toUpperCase(local105) != Character.toUpperCase(local110)) {
				@Pc(125) char local125 = Character.toLowerCase(local105);
				@Pc(128) char local128 = Character.toLowerCase(local110);
				if (local128 != local125) {
					return Static25.method2928(arg1, local125) - Static25.method2928(arg1, local128);
				}
			}
		}
		...
		for (@Pc(152) int local152 = 0; local152 < local150; local152++) {
			...
			@Pc(167) int local167;
			if (arg1 == 2) {
				local167 = local18 - local152 - 1;
				local174 = local8 - local152 - 1;
			} else {
				local167 = local152;
				local174 = local152;
			}
			@Pc(184) char local184 = arg2.charAt(local174);
			@Pc(188) char local188 = arg0.charAt(local167);
			if (local184 != local188 && Character.toUpperCase(local184) != Character.toUpperCase(local188)) {
				@Pc(203) char local203 = Character.toLowerCase(local184);
				@Pc(206) char local206 = Character.toLowerCase(local188);
				if (local203 != local206) {
					return Static25.method2928(arg1, local203) - Static25.method2928(arg1, local206);
				}
			}
		}
		@Pc(233) int local233 = local8 - local18;
		if (local233 != 0) {
			return local233;
		}
		for (@Pc(240) int local240 = 0; local240 < local150; local240++) {
			@Pc(247) char local247 = arg2.charAt(local240);
			@Pc(251) char local251 = arg0.charAt(local240);
			if (local247 != local251) {
				return Static25.method2928(arg1, local247) - Static25.method2928(arg1, local251);
			}
		}
		return 0;
	}
	...
	public static void method4717() {
		Static4.aClass26_28.method517(5);
		Static3.aClass26_23.method517(5);
	}
	...
	public static void method4721() {
		...
		if ((Static4.aByteArrayArrayArray17[Static7.anInt5334][Static4.aClass53_Sub1_Sub1_2.anInt3974 >> 7][Static4.aClass53_Sub1_Sub1_2.anInt4002 >> 7] & 0x4) != 0) {
			Static9.method279(0, Static4.aClass53_Sub1_Sub1_2.anInt3974 >> 7, false, Static4.aClass53_Sub1_Sub1_2.anInt4002 >> 7, Static1.aClass4_Sub19ArrayArrayArray1);
		}
		...
		@Pc(184) int local184 = Static4.aClass53_Sub1_Sub1_2.anInt4002 >> 7;
		@Pc(196) int local196;
		...
		@Pc(208) int local208 = Static4.aClass53_Sub1_Sub1_2.anInt3974 >> 7;
		@Pc(216) int local216;
	...
	public static void method4727() {
		Static5.aClass26_42.method517(5);
		Static6.aClass26_46.method517(5);
	}

	@OriginalMember(owner = "client!wf", name = "b", descriptor = "(BI)Lclient!sa;")
	public static Class153 method4731(@OriginalArg(1) int arg0) {
		@Pc(10) Class153 local10 = (Class153) Static2.aClass26_16.method518((long) arg0);
		if (local10 != null) {
			return local10;
		}
	...
	public static Class34 method4776(@OriginalArg(1) int arg0) {
		@Pc(10) Class34 local10 = (Class34) Static6.aClass26_51.method518((long) arg0);
		if (local10 != null) {
			return local10;
		}
