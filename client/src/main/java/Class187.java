...
public final class Class187 {
	...
	public Class187(@OriginalArg(0) Class4_Sub10 arg0) {
		@Pc(16) int local16 = arg0.method4629();
		if ((local16 & 0x1) == 0) {
			this.anInt6034 = Static4.anInt3364;
		} else {
			this.anInt6034 = arg0.method4595();
		}
		if ((local16 & 0x2) == 0) {
			this.aFloat148 = 1.1523438F;
		} else {
			this.aFloat148 = (float) arg0.method4616() / 256.0F;
		}
		if ((local16 & 0x4) == 0) {
			this.aFloat150 = 0.69921875F;
		} else {
			this.aFloat150 = (float) arg0.method4616() / 256.0F;
		}
		if ((local16 & 0x8) == 0) {
			this.aFloat149 = 1.2F;
		} else {
			this.aFloat149 = (float) arg0.method4616() / 256.0F;
		}
		if ((local16 & 0x10) == 0) {
			this.anInt6033 = -50;
			this.anInt6035 = -50;
			...
			this.anInt6035 = arg0.method4576();
			this.anInt6037 = arg0.method4576();
			this.anInt6033 = arg0.method4576();
		}
		if ((local16 & 0x20) == 0) {
			this.anInt6036 = Static4.anInt3365;
		} else {
			this.anInt6036 = arg0.method4595();
		}
		if ((local16 & 0x40) == 0) {
			this.anInt6043 = 0;
		} else {
			this.anInt6043 = arg0.method4616();
		}
		if ((local16 & 0x80) != 0) {
			this.aClass4_Sub3_Sub10_7 = Static19.method1838(arg0.method4616(), arg0.method4616(), arg0.method4616(), arg0.method4616(), arg0.method4616(), arg0.method4616());
	...
	public final void method4786(@OriginalArg(0) Class4_Sub10 arg0) {
		this.aFloat151 = (float) (arg0.method4629() * 8) / 255.0F;
		this.aFloat152 = (float) (arg0.method4629() * 8) / 255.0F;
		this.aFloat153 = (float) (arg0.method4629() * 8) / 255.0F;
	}
}
