...
public final class Js5GlTextureProvider extends Js5TextureProvider implements GlTextureProvider {
	...
	public final int method455(@OriginalArg(0) int id) {
		return this.getMaterial(id).aByte9 & 0xFF;
	}
	...
	public final int method446(@OriginalArg(0) int id) {
		return this.getMaterial(id).aShort26 & 0xFFFF;
	}
	...
	public final void method454(@OriginalArg(2) int id, @OriginalArg(1) int arg0) {
		Static24.method2652(this.getMaterial(id).aByte8 & 0xFF, this.getMaterial(id).aByte9 & 0xFF);
	...
	private GlSolidColorTexture getSolidColorTexture(@OriginalArg(1) int id) {
		...
		if (texture == null) {
			@Pc(27) GlSolidColorTexture newTexture = new GlSolidColorTexture(this.getMaterial(id).aShort26 & 0xFFFF);
	...
	public final int method444(@OriginalArg(0) int id) {
		return this.getMaterial(id).aByte8 & 0xFF;
	}
}
