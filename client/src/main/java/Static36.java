...
public final class Static36 {
	...
	public static void method4406() {
		@Pc(6) int local6 = Static5.aClass4_Sub10_Sub1_2.method4652(8);
		...
		for (@Pc(55) int local55 = 0; local55 < local6; local55++) {
			...
			@Pc(66) Class53_Sub1_Sub1 local66 = Static5.aClass53_Sub1_Sub1Array1[local62];
			@Pc(73) int local73 = Static5.aClass4_Sub10_Sub1_2.method4652(1);
			if (local73 == 0) {
				Static4.anIntArray317[Static3.anInt2510++] = local62;
				local66.anInt3990 = Static2.anInt954;
			} else {
				@Pc(94) int local94 = Static5.aClass4_Sub10_Sub1_2.method4652(2);
				if (local94 == 0) {
					Static4.anIntArray317[Static3.anInt2510++] = local62;
					local66.anInt3990 = Static2.anInt954;
					...
					Static4.anIntArray317[Static3.anInt2510++] = local62;
					local66.anInt3990 = Static2.anInt954;
					@Pc(140) int local140 = Static5.aClass4_Sub10_Sub1_2.method4652(3);
					local66.method3308(local140, 1);
					@Pc(150) int local150 = Static5.aClass4_Sub10_Sub1_2.method4652(1);
					if (local150 == 1) {
						Static7.anIntArray587[Static6.anInt4760++] = local62;
					}
				} else if (local94 == 2) {
					...
					if (Static5.aClass4_Sub10_Sub1_2.method4652(1) == 1) {
						@Pc(193) int local193 = Static5.aClass4_Sub10_Sub1_2.method4652(3);
						local66.method3308(local193, 2);
						@Pc(205) int local205 = Static5.aClass4_Sub10_Sub1_2.method4652(3);
						local66.method3308(local205, 2);
					} else {
						@Pc(219) int local219 = Static5.aClass4_Sub10_Sub1_2.method4652(3);
						local66.method3308(local219, 0);
					}
					@Pc(229) int local229 = Static5.aClass4_Sub10_Sub1_2.method4652(1);
					if (local229 == 1) {
						Static7.anIntArray587[Static6.anInt4760++] = local62;
					}
				} else if (local94 == 3) {
	...
	public static boolean method4408(@OriginalArg(1) int arg0) {
	...
	public static int method4464(@OriginalArg(0) int arg0, @OriginalArg(2) Class185 arg1) {
		...
		try {
			...
			while (true) {
				...
				if (local43 == 1) {
					local45 = Static7.anIntArray501[local30[local32++]];
				}
				if (local43 == 15) {
					local38 = 1;
				}
				...
				if (local43 == 2) {
					local45 = Static7.anIntArray599[local30[local32++]];
				}
				if (local43 == 3) {
					local45 = Static7.anIntArray637[local30[local32++]];
				}
				if (local43 == 4) {
					...
					if (local134 != -1 && (!Static35.method4361(local134).aBoolean350 || Static7.aBoolean370)) {
				...
				if (local43 == 5) {
					local45 = Static1.anIntArray2[local30[local32++]];
				}
				if (local43 == 6) {
					local45 = Class65.anIntArray165[Static7.anIntArray599[local30[local32++]] - 1];
				}
				if (local43 == 7) {
					local45 = Static1.anIntArray2[local30[local32++]] * 100 / 46875;
				}
				if (local43 == 8) {
					local45 = Static4.aClass53_Sub1_Sub1_2.anInt1597;
				}
				if (local43 == 9) {
					for (@Pc(237) int local237 = 0; local237 < 25; local237++) {
						if (Static7.aBooleanArray25[local237]) {
							local45 += Static7.anIntArray599[local237];
						}
					}
				}
				if (local43 == 10) {
					...
					if (local281 != -1 && (!Static35.method4361(local281).aBoolean350 || Static7.aBoolean370)) {
				...
				if (local43 == 11) {
					local45 = Static2.anInt2248;
				}
				if (local43 == 12) {
					local45 = Static3.anInt2048;
				}
				if (local43 == 13) {
					@Pc(345) int local345 = local32 + 1;
					@Pc(348) int local348 = Static1.anIntArray2[local30[local32]];
					local32 = local345 + 1;
					@Pc(353) int local353 = local30[local345];
					local45 = (0x1 << local353 & local348) == 0 ? 0 : 1;
				}
				if (local43 == 14) {
					@Pc(375) int local375 = local30[local32++];
					local45 = Static35.method4311(local375);
				}
				if (local43 == 18) {
					local45 = Static5.anInt3983 + (Static4.aClass53_Sub1_Sub1_2.anInt3974 >> 7);
				}
				if (local43 == 19) {
					local45 = (Static4.aClass53_Sub1_Sub1_2.anInt4002 >> 7) + Static7.anInt5479;
				}
				if (local43 == 20) {
	...
	public static void method4522() {
		...
		for (@Pc(17) int local17 = 0; local17 < Static5.anInt4195; local17++) {
			...
			if (Static2.anInt954 != Static3.aClass53_Sub1_Sub2Array1[local28].anInt3990) {
				if (Static3.aClass53_Sub1_Sub2Array1[local28].aClass168_1.method4260()) {
					Static25.method2931(Static3.aClass53_Sub1_Sub2Array1[local28]);
				}
				Static3.aClass53_Sub1_Sub2Array1[local28].method3317(null);
		...
		for (@Pc(87) int local87 = 0; local87 < Static6.anInt4451; local87++) {
			if (Static3.aClass53_Sub1_Sub2Array1[Static7.anIntArray595[local87]] == null) {
				throw new RuntimeException("gnp2 pos:" + local87 + " size:" + Static6.anInt4451);
			}
		}
	}
	...
	public static void method4524(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3) {
		...
		for (@Pc(266) Class4_Sub3_Sub7 local266 = (Class4_Sub3_Sub7) Static3.aClass175_12.method4332(); local266 != null; local266 = (Class4_Sub3_Sub7) Static3.aClass175_12.method4340()) {
