...
public final class Static13 {
		...
		if (arg0.anInt4005 != -1) {
			...
			if (local19 == null || local19.anIntArray95 == null) {
				...
				if (arg0.anInt4046 < local19.anIntArray95.length && local19.anIntArray94[arg0.anInt4046] < arg0.anInt4000) {
					...
					arg0.anInt4000 = 1;
					arg0.anInt4046++;
					Static29.method3461(local19, arg0.z, arg0.x, arg0.anInt4046, arg0 == Player.self);
				}
				if (arg0.anInt4046 >= local19.anIntArray95.length) {
					arg0.anInt4000 = 0;
					arg0.anInt4046 = 0;
					Static29.method3461(local19, arg0.z, arg0.x, arg0.anInt4046, Player.self == arg0);
				}
			...
			if (local152 == -1) {
				...
				label303:
				{
					...
					if (local166 == null || local166.anIntArray95 == null) {
						...
						if (arg0.anInt4026 < 0) {
							arg0.anInt4026 = 0;
							Static29.method3461(local166, arg0.z, arg0.x, 0, arg0 == Player.self);
						}
						arg0.anInt3968++;
						if (local166.anIntArray95.length > arg0.anInt4026 && local166.anIntArray94[arg0.anInt4026] < arg0.anInt3968) {
							arg0.anInt3968 = 1;
							arg0.anInt4026++;
							Static29.method3461(local166, arg0.z, arg0.x, arg0.anInt4026, Player.self == arg0);
						}
		...
		if (arg0.anInt4007 != -1 && arg0.anInt3996 == 0) {
			...
			if (local538 == null || local538.anIntArray95 == null) {
				...
				if (local538.anIntArray95.length > arg0.anInt3970 && arg0.anInt4044 > local538.anIntArray94[arg0.anInt3970]) {
					arg0.anInt3970++;
					arg0.anInt4044 = 1;
					Static29.method3461(local538, arg0.z, arg0.x, arg0.anInt3970, arg0 == Player.self);
				}
				...
				if (local760.anInt4461 > 0) {
					...
					if (local782 == null || local782.anIntArray95 == null) {
						...
						if (local782.anIntArray95.length > local760.anInt4462 && local782.anIntArray94[local760.anInt4462] < local760.anInt4460) {
							...
							local760.anInt4462++;
							Static29.method3461(local782, arg0.z, arg0.x, local760.anInt4462, arg0 == Player.self);
						}
	...
	public static Class4_Sub3_Sub14 method965(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) PlayerAppearance arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) boolean arg7) {
		...
		if (local9.certificateTemplate != -1) {
			local68 = (Class4_Sub3_Sub14_Sub1) method965(1, false, 10, true, arg4, 0, local9.certificateLink, true);
			if (local68 == null) {
				return null;
			}
		} else if (local9.lentTemplate != -1) {
			local68 = (Class4_Sub3_Sub14_Sub1) method965(arg0, false, arg2, false, arg4, arg5, local9.lentLink, true);
			if (local68 == null) {
				return null;
			}
		}
		...
		@Pc(174) int local174 = local145 * Class109.anIntArray298[local9.xAngle2d] >> 16;
		@Pc(191) int local191 = Class109.anIntArray299[local9.xAngle2d] * local145 >> 16;
	...
	public static boolean method1004(@OriginalArg(0) int arg0, @OriginalArg(1) long arg1, @OriginalArg(3) int arg2) {
		...
		if (local23 == 10 || local23 == 11 || local23 == 22) {
			...
			Static15.method1337(Player.self.anIntArray422[0], 0, local52, local63, arg0, Player.self.anIntArray426[0], 0, local66, arg2);
		} else {
			Static15.method1337(Player.self.anIntArray422[0], local12, 0, 0, arg0, Player.self.anIntArray426[0], local23 + 1, 0, arg2);
		}
		return true;
	}
