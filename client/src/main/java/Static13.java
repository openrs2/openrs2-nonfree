		...
		if (arg0.movementSeqId != -1) {
			...
			if (local19 == null || local19.anIntArray95 == null) {
				...
				if (arg0.anInt4046 < local19.anIntArray95.length && local19.anIntArray94[arg0.anInt4046] < arg0.anInt4000) {
					...
					arg0.anInt4000 = 1;
					arg0.anInt4046++;
					SoundPlayer.playSeqSound(local19, arg0.zFine, arg0.xFine, arg0.anInt4046, arg0 == PlayerList.self);
				}
				if (arg0.anInt4046 >= local19.anIntArray95.length) {
					arg0.anInt4000 = 0;
					arg0.anInt4046 = 0;
					SoundPlayer.playSeqSound(local19, arg0.zFine, arg0.xFine, arg0.anInt4046, PlayerList.self == arg0);
				}
			...
			if (local152 == -1) {
				...
				label303:
				{
					...
					if (local166 == null || local166.anIntArray95 == null) {
						...
						if (arg0.anInt4026 < 0) {
							arg0.anInt4026 = 0;
							SoundPlayer.playSeqSound(local166, arg0.zFine, arg0.xFine, 0, arg0 == PlayerList.self);
						}
						arg0.anInt3968++;
						if (local166.anIntArray95.length > arg0.anInt4026 && local166.anIntArray94[arg0.anInt4026] < arg0.anInt3968) {
							arg0.anInt3968 = 1;
							arg0.anInt4026++;
							SoundPlayer.playSeqSound(local166, arg0.zFine, arg0.xFine, arg0.anInt4026, PlayerList.self == arg0);
						}
		...
		if (arg0.seqId != -1 && arg0.anInt3996 == 0) {
			...
			if (local538 == null || local538.anIntArray95 == null) {
				...
				if (local538.anIntArray95.length > arg0.anInt3970 && arg0.anInt4044 > local538.anIntArray94[arg0.anInt3970]) {
					arg0.anInt3970++;
					arg0.anInt4044 = 1;
					SoundPlayer.playSeqSound(local538, arg0.zFine, arg0.xFine, arg0.anInt3970, arg0 == PlayerList.self);
				}
				...
				if (local760.anInt4461 > 0) {
					...
					if (local782 == null || local782.anIntArray95 == null) {
						...
						if (local782.anIntArray95.length > local760.anInt4462 && local782.anIntArray94[local760.anInt4462] < local760.anInt4460) {
							...
							local760.anInt4462++;
							SoundPlayer.playSeqSound(local782, arg0.zFine, arg0.xFine, local760.anInt4462, arg0 == PlayerList.self);
						}
