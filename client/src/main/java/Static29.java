									...
									while (true) {
										while (true) {
											...
											if (local469) {
												...
												if (local549 != null && (local549.pickKey & 0x80000000L) != 0L) {
											...
											if (local469) {
												...
												if (local1001 != null && (local1001.pickKey & 0x80000000L) == 0L) {
