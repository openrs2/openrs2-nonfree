...
public final class ParticleEmitterNode extends SceneGraphNode {
	...
	public final SceneGraphLinkedList particles;
	...
	public ParticleEmitterNode(@OriginalArg(0) ParticleEmitter emitter, @OriginalArg(1) ParticleSystem system, @OriginalArg(2) long arg2) {
		this.emitter = emitter;
		this.system = system;
		this.particles = new SceneGraphLinkedList();
