...
public final class Static8 {
	...
	public static void method2(@OriginalArg(0) boolean arg0, @OriginalArg(2) int arg1, @OriginalArg(3) boolean arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6) {
		...
		if (arg0) {
			...
			for (@Pc(166) int local166 = 0; local166 < 32768; local166++) {
				@Pc(175) Class53_Sub1_Sub2 local175 = Static3.aClass53_Sub1_Sub2Array1[local166];
				if (local175 != null) {
					local175.anInt4002 -= local90 * 128;
					local175.anInt3974 -= local95 * 128;
					if (local175.anInt3974 >= 0 && local175.anInt3974 <= 13184 && local175.anInt4002 >= 0 && local175.anInt4002 <= 13184) {
						...
						Static3.aClass53_Sub1_Sub2Array1[local166].method3317(null);
			...
			for (@Pc(103) int local103 = 0; local103 < 32768; local103++) {
				@Pc(112) Class53_Sub1_Sub2 local112 = Static3.aClass53_Sub1_Sub2Array1[local103];
				if (local112 != null) {
		...
		for (@Pc(263) int local263 = 0; local263 < 2048; local263++) {
			@Pc(272) Class53_Sub1_Sub1 local272 = Static5.aClass53_Sub1_Sub1Array1[local263];
			if (local272 != null) {
	...
	public static void method5(@OriginalArg(1) Class58 arg0, @OriginalArg(2) Class58 arg1) {
		...
		Static1.aClass58_22.method1371(34);
	...
	public static void method7(@OriginalArg(0) int arg0, @OriginalArg(2) String arg1) {
		...
		for (@Pc(21) int local21 = 0; local21 < Static3.anInt2510; local21++) {
			@Pc(30) Class53_Sub1_Sub1 local30 = Static5.aClass53_Sub1_Sub1Array1[Static4.anIntArray317[local21]];
	...
	public static void method8() {
		for (@Pc(11) int local11 = 0; local11 < Static6.anInt4451; local11++) {
			...
			@Pc(22) Class53_Sub1_Sub2 local22 = Static3.aClass53_Sub1_Sub2Array1[local18];
			if (local22 != null) {
				Static15.method1428(local22.aClass168_1.anInt5262, local22);
			}
		}
	}
	...
	public static void method73(@OriginalArg(0) Object[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Object[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		if (arg0 == arg2) {
			...
			if (arg3 > arg1 && arg3 < arg1 + arg4) {
				...
				arg4 += 7;
				while (local19 >= arg4) {
					@Pc(34) int local34 = local23 - 1;
					@Pc(37) int local37 = local19 - 1;
					arg2[local23] = arg0[local19];
					arg2[local34--] = arg0[local37--];
					arg2[local34--] = arg0[local37--];
					arg2[local34--] = arg0[local37--];
					arg2[local34--] = arg0[local37--];
					arg2[local34--] = arg0[local37--];
		...
		arg4 -= 7;
		while (arg1 < arg4) {
			@Pc(121) int local121 = arg3 + 1;
			@Pc(124) int local124 = arg1 + 1;
			arg2[arg3] = arg0[arg1];
			arg2[local121++] = arg0[local124++];
			arg2[local121++] = arg0[local124++];
			arg2[local121++] = arg0[local124++];
			arg2[local121++] = arg0[local124++];
			arg2[local121++] = arg0[local124++];
	...
	public static void method79(@OriginalArg(0) long[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) long[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		arg4 -= 3;
		while (arg1 < arg4) {
			@Pc(89) int local89 = arg3 + 1;
			@Pc(92) int local92 = arg1 + 1;
			arg2[arg3] = arg0[arg1];
			arg2[local89++] = arg0[local92++];
			arg2[local89++] = arg0[local92++];
			arg3 = local89 + 1;
			arg1 = local92 + 1;
			arg2[local89] = arg0[local92];
	...
	public static void method89(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		while (local33 != null) {
			...
			@Pc(47) int local47 = local44.anInt5102;
			if (local44.anInt5075 == 1) {
	...
	public static Class181 method99(@OriginalArg(0) int arg0) {
		...
		@Pc(28) byte[] local28 = Static2.aClass58_38.method1372(Static37.method4662(arg0), Static26.method2980(arg0));
	...
	public static void method109(@OriginalArg(1) Class181 arg0, @OriginalArg(2) int arg1, @OriginalArg(3) Class53_Sub1_Sub2 arg2, @OriginalArg(4) int arg3, @OriginalArg(5) Class53_Sub1_Sub1 arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6) {
		...
		if (arg0 != null) {
			...
			if (local86 != null) {
				local9.anInt2117 = (local86.anInt5262 + arg1) * 128;
				local9.anInt2112 = (local86.anInt5262 + arg3) * 128;
			...
			local9.anInt2112 = (arg4.method3311() + arg3) * 128;
	...
	public static Class4_Sub3_Sub5 method121(@OriginalArg(0) Class58 arg0, @OriginalArg(1) Class58 arg1, @OriginalArg(3) int arg2) {
		return Static9.method197(arg0, arg2, 0) ? Static10.method304(arg1.method1372(arg2, 0)) : null;
	}
