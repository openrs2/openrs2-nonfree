...
public final class Class56_Sub2 extends Class56 {
	...
	public final void method2815(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		Static17.method1600(this.anInt3418);
		this.method2818();
	...
	public final void finalize() throws Throwable {
		if (this.anInt3418 != -1) {
			Static25.method2722(this.anInt3418, this.anInt3419, this.anInt3415);
			this.anInt3418 = -1;
			this.anInt3419 = 0;
		}
		if (this.anInt3414 != -1) {
			Static24.method2717(this.anInt3414, this.anInt3415);
			this.anInt3414 = -1;
		}
		super.finalize();
	}
	...
	private void method2817() {
		...
		if (this.anInt3414 == -1) {
			...
			this.anInt3415 = Static4.anInt3332;
		}
	...
	private void method2819(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1) {
		...
		Static4.anInt3333 += local93.limit() - this.anInt3419;
		this.anInt3419 = local93.limit();
	}

	@OriginalMember(owner = "client!n", name = "a", descriptor = "(IILclient!oa;)V")
	public final void method2820(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class4_Sub3_Sub14_Sub2 arg2) {
		if (arg2 == null) {
			return;
		}
		Static17.method1596();
		...
		local11.glVertex2f((float) (arg0 + this.anInt3408), (float) (Static3.anInt2083 - arg1));
		...
		local11.glVertex2f((float) arg0, (float) (Static3.anInt2083 - arg1 - this.anInt3413));
		local11.glMultiTexCoord2f(GL.GL_TEXTURE1, local68, local80);
		local11.glTexCoord2f(local107, local115);
		local11.glVertex2f((float) (arg0 + this.anInt3408), (float) (Static3.anInt2083 - arg1 - this.anInt3413));
		local11.glEnd();
