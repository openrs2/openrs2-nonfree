...
public final class Class4_Sub3_Sub11 extends Class4_Sub3 {
	...
	private void method1906(@OriginalArg(0) int arg0, @OriginalArg(2) Class4_Sub10 arg1) {
		if (arg0 == 1) {
			this.aStringArray17 = Static12.method721('<', arg1.method4593());
		} else if (arg0 == 2) {
			@Pc(103) int local103 = arg1.method4629();
			this.anIntArray212 = new int[local103];
			for (@Pc(109) int local109 = 0; local109 < local103; local109++) {
				this.anIntArray212[local109] = arg1.method4616();
			}
		} else if (arg0 == 3) {
			@Pc(27) int local27 = arg1.method4629();
			this.anIntArrayArray20 = new int[local27][];
			this.anIntArray210 = new int[local27];
			for (@Pc(37) int local37 = 0; local37 < local27; local37++) {
				@Pc(48) int local48 = arg1.method4616();
				...
				for (@Pc(63) int local63 = 0; local63 < Static5.anIntArray456[local48]; local63++) {
					this.anIntArrayArray20[local37][local63] = arg1.method4616();
				}
			}
		} else if (arg0 == 4) {
	...
	public final void method1908(@OriginalArg(0) Class4_Sub10 arg0) {
		while (true) {
	...
	public final String method1909(@OriginalArg(1) Class4_Sub10 arg0) {
		...
		if (this.anIntArray210 != null) {
			for (@Pc(21) int local21 = 0; local21 < this.anIntArray210.length; local21++) {
				...
				local16.append(Static20.method1940(arg0.method4596(Static3.anIntArray191[this.anIntArray210[local21]]), this.anIntArray210[local21], this.anIntArrayArray20[local21]));
			}
		}
	...
	public final void method1911(@OriginalArg(0) int[] arg0, @OriginalArg(2) Class4_Sub10 arg1) {
		if (this.anIntArray210 == null) {
			return;
		}
		for (@Pc(13) int local13 = 0; local13 < this.anIntArray210.length && local13 < arg0.length; local13++) {
			...
			if (local29 > 0) {
				arg1.method4606((long) arg0[local13], local29);
			}
		}
	}
