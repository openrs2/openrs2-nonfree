...
public final class GlVertexBufferObject {
	...
	public void updateArrayBuffer(@OriginalArg(0) ByteBuffer buffer) {
	...
	public void setElementArrayBuffer(@OriginalArg(0) ByteBuffer buffer) {
	...
	public void setArrayBuffer(@OriginalArg(0) ByteBuffer buffer) {
		@Pc(1) GL gl = GlRenderer.gl;
		gl.glBindBufferARB(GL.GL_ARRAY_BUFFER, this.id);
